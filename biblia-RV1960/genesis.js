export default [
  ...
  [
    ...
    'y dijo: /n Maldito sea Canaán;  Siervo de siervos será a sus hermanos.',
    '/n Dijo más:  Bendito por Jehová mi Dios sea Sem, Y sea Canaán su siervo.',
  ...
  [
    ...
    'y le respondió Jehová: /n Dos naciones hay en tu seno,  Y dos pueblos serán divididos desde tus entrañas;  El un pueblo será más fuerte que el otro pueblo,  Y el mayor servirá al menor.',
  ...
  [
    ...
    'Y Jacob se acercó, y le besó; y olió Isaac el olor de sus vestidos, y le bendijo, diciendo: /n Mira, el olor de mi hijo,  Como el olor del campo que Jehová ha bendecido;',
    'Dios, pues, te dé del rocío del cielo,  Y de las grosuras de la tierra,  Y abundancia de trigo y de mosto.',
    '/n Sírvante pueblos,  Y naciones se inclinen a ti;  Sé señor de tus hermanos,  Y se inclinen ante ti los hijos de tu madre.  Malditos los que te maldijeren,  Y benditos los que te bendijeren.',
    ...
    'Entonces Isaac su padre habló y le dijo: /n He aquí, será tu habitación en grosuras de la tierra,  Y del rocío de los cielos de arriba;',
  ...
  [
    ...
    '/n Rubén, tú eres mi primogénito,  mi fortaleza, y el principio de mi vigor;  Principal en dignidad, principal en poder.',
    ...
    '/n Maldito su furor, que fue fiero;  Y su ira, que fue dura.Yo los apartaré en Jacob,  Y los esparciré en Israel.',
    ...
    '/n Zabulón en puertos de mar habitará;  Será para puerto de naves,  Y su límite hasta Sidón.',
    '/n Isacar, asno fuerte  Que se recuesta entre los apriscos;',
    '/n Y vio que el descanso era bueno,  y que la tierra era deleitosa;  Y bajó su hombro para llevar,  Y sirvió en tributo.',
    '/n Dan juzgará a su pueblo,  Como una de las tribus de Israel.',
    ...
    '/n El pan de Aser será substancioso,  Y él dará deleites al rey.',
    '/n Neftalí, cierva suelta,  Que pronunciará dichos hermosos.',
    '/n Rama fructífera es José,  Rama fructífera junto a una fuente,  Cuyos vástagos se extienden sobre el muro.',
    '/n Le causaron amargura,  Le asaetearon,  Y le aborrecieron los arqueros;',
    '/n Mas su arco se mantuvo poderoso,  Y los brazos de sus manos se fortalecieron  Por las manos del Fuerte de Jacob  (Por el nombre del Pastor, la Roca de Israel),',
    '/n Por el Dios de tu padre, el cual te ayudará,  Por el Dios Omnipotente, el cual te bendecirá  Con bendiciones de los cielos de arriba,  Con bendiciones del abismo que está abajo,  Con bendiciones de los pechos y del vientre.',
    '/n Las bendiciones de tu padre  Fueron mayores que las bendiciones de mis progenitores;  Hasta el término de los collados eternos  Serán sobre la cabeza de José,  Y sobre la frente del que fue apartado de entre sus hermanos.',
