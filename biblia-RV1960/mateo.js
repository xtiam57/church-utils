export default [
  ...
  [
    ...
    'Porque de cierto os digo que hasta que pasen el cielo y la tierra, ni una jota ni una tilde pasará /nde la ley, hasta que todo se haya cumplido.',
  ...
  [
    ...
    'Porque éste es de quien está escrito: /n/nHe aquí, yo envío mi mensajero delante de tu faz, /nEl cual preparará tu camino delante de ti.',
  ...
  [
    ...
    'para que se cumpliese lo dicho por el profeta Isaías, cuando dijo:',
    '/nHe aquí mi siervo, a quien he escogido; /nMi Amado, en quien se agrada mi alma; /nPondré mi Espíritu sobre él, /nY a los gentiles anunciará juicio.',
    ...
    '/nY en su nombre esperarán los gentiles.',
  ...
  [
    ...
    'De manera que se cumple en ellos la profecía de Isaías, que dijo: /n/nDe oído oiréis, y no entenderéis; /nY viendo veréis, y no percibiréis.',
    '/nPorque el corazón de este pueblo se ha engrosado, /nY con los oídos oyen pesadamente, /nY han cerrado sus ojos; /nPara que no vean con los ojos, /nY oigan con los oídos, /nY con el corazón entiendan, /nY se conviertan, /nY yo los sane.',
    ...
    'para que se cumpliese lo dicho por el profeta, cuando dijo: /n/nAbriré en parábolas mi boca; /nDeclararé cosas escondidas desde la fundación del mundo.',
  ...
  [
    ...
    'Entonces mandóa la gente recostarse sobre la hierba; y tomando los cinco panes y los dos peces, y levantando los ojos al cielo, bendijo, y partió y dio los panes a los discípulos, y los discípulos a la multitud.',
  ...
  [
    ...
    '/nPues en vano me honran, /nEnseñando como doctrinas, mandamientos de hombres.',
  ...
  [
    ...
    'Jesús les dijo: ¿Nunca leísteis en las Escrituras: /n/nLa piedra que desecharon los edificadores, /nHa venido a ser cabeza del ángulo. /nEl Señor ha hecho esto, /nY es cosa maravillosa a nuestros ojos?',
  ...
  [
    ...
    'Y estando él sentado en el monte de los Olivos, los discípulos se le acercaron aparte, /ndiciendo: Dinos, ¿cuándo serán estas cosas, y qué señal habrá de tu venida, y del fin del siglo?',
