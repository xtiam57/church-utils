export default [
  ...
  [
    ...
    'Y los hijos de Merari: Mahli y Musi. Estas son las familas de Leví por sus linajes.',
  ...
  [
    ...
    'Y Jehová hizo conforme a la palabra de Moisés, y quitó todas aquellas moscas de Faraón, de sus siervos y de su pueblo, sin que quedara una.',
  ...
  [
    'Entonces cantó Moisés y los hijos de Israel este cántico a Jehová, y dijeron: /n Cantaré yo a Jehová, porque se ha magnificado grandemente; Ha echado en el mar al caballo y al jinete.',
    '/n Jehová es mi fortaleza y mi cántico, Y ha sido mi salvación. Este es mi Dios, y lo alabaré; Dios de mi padre, y lo enalteceré.',
    '/n Jehová es varón de guerra; Jehová es su nombre.',
    '/n Echó en el mar los carros de Faraón y su ejército; Y sus capitanes escogidos fueron hundidos en el Mar Rojo.',
    '/n Los abismos los cubrieron; Descendieron a las profundidades como piedra.',
    '/n Tu diestra, oh Jehová, ha sido magnificada en poder; Tu diestra, oh Jehová, ha quebrantado al enemigo.',
    '/n Y con la grandeza de tu poder has derribado a los que se levantaron contra ti. Enviaste tu ira; los consumió como a hojarasca.',
    '/n Al soplo de tu aliento se amontonaron las aguas; Se juntaron las corrientes como en un montón; Los abismos se cuajaron en medio del mar.',
    '/n El enemigo dijo: Perseguiré, apresaré, repartiré despojos; Mi alma se saciará de ellos; Sacaré mi espada, los destruirá mi mano.',
    '/n Soplaste con tu viento; los cubrió el mar; Se hundieron como plomo en las impetuosas aguas.',
    '/n ¿Quién como tú, oh Jehová, entre los dioses? ¿Quién como tú, magnífico en santidad, Terrible en maravillosas hazañas, hacedor de prodigios?',
    '/n Extendiste tu diestra; La tierra los tragó.',
    '/n Condujiste en tu misericordia a este pueblo que redimiste; Lo llevaste con tu poder a tu santa morada.',
    '/n Lo oirán los pueblos, y temblarán; Se apoderará dolor de la tierra de los filisteos.',
    '/n Entonces los caudillos de Edom se turbarán; A los valientes de Moab les sobrecogerá temblor; Se acobardarán todos los moradores de Canaán.',
    '/n Caiga sobre ellos temblor y espanto; A la grandeza de tu brazo enmudezcan como una piedra; Hasta que haya pasado tu pueblo, oh Jehová, Hasta que haya pasado este pueblo que tú rescataste.',
    '/n Tú los introducirás y los plantarás en el monte de tu heredad, En el lugar de tu morada, que tú has preparado, oh Jehová, En el santuario que tus manos, oh Jehová, han afirmado.',
    '/n Jehová reinará eternamente y para siempre.',
    ...
    'Y María les respondía: /n Cantad a Jehová, porque en extremo se ha engrandecido; Ha echado en el mar al caballo y al jinete ',
