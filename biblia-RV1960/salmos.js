export default [
  [
    '/nBienaventurado el varón que no anduvo en consejo de malos, /nNi estuvo en camino de pecadores, /nNi en silla de escarnecedores se ha sentado;',
    '/nSino que en la ley de Jehová está su delicia, /nY en su ley medita de día y de noche.',
    '/nSerá como árbol plantado junto a corrientes de aguas, /nQue da su fruto en su tiempo, /nY su hoja no cae; /nY todo lo que hace, prosperará.',
    '/nNo así los malos, /nQue son como el tamo que arrebata el viento.',
    '/nPor tanto, no se levantarán los malos en el juicio, /nNi los pecadores en la congregación de los justos.',
    '/nPorque Jehová conoce el camino de los justos; /nMas la senda de los malos perecerá.'
  ],
  [
    '/n¿Por qué se amotinan las gentes, /nY los pueblos piensan cosas vanas?',
    '/nSe levantarán los reyes de la tierra, /nY príncipes consultarán unidos /nContra Jehová y contra su ungido, diciendo:',
    ...
    '/nPero yo he puesto mi rey /nSobre Sion, mi santo monte.',
    ...
    '/nAhora, pues, oh reyes, sed prudentes; /nAdmitid amonestación, jueces de la tierra.',
    '/nServid a Jehová con temor, /nY alegraos con temblor.',
  ...
  [
    ...
    '/nNo temeré a diez millares de gente, /nQue pusieren sitio contra mí.',
    ...
    '/nLa salvación es de Jehová; /nSobre tu pueblo sea tu bendición. Selah'
  ],
  [
    '/nRespóndeme cuando clamo, oh Dios de mi justicia. /nCuando estaba en angustia, tú me hiciste ensanchar; /nTen misericordia de mí, y oye mi oración.',
    ...
    '/nTemblad, y no pequéis; /nMeditad en vuestro corazón estando en vuestra cama, y callad. Selah',
    '/nOfreced sacrificios de justicia, /nY confiad en Jehová.',
    '/nMuchos son los que dicen: ¿Quién nos mostrará el bien? /nAlza sobre nosotros, oh Jehová, la luz de tu rostro.',
    '/nTú diste alegría a mi corazón /nMayor que la de ellos cuando abundaba su grano y su mosto.',
  ...
  [
    ...
    '/nEstá atento a la voz de mi clamor, Rey mío y Dios mío, /nPorque a ti oraré.',
    '/nOh Jehová, de mañana oirás mi voz; /nDe mañana me presentaré delante de ti, y esperaré.',
    '/nPorque tú no eres un Dios que se complace en la maldad; /nEl malo no habitará junto a ti.',
    '/nLos insensatos no estarán delante de tus ojos; /nAborreces a todos los que hacen iniquidad.',
  ...
  [
    ...
    '/nTen misericordia de mí, oh Jehová, porque estoy enfermo; /nSáname, oh Jehová, porque mis huesos se estremecen.',
    '/nMi alma también está muy turbada; /nY tú, Jehová, ¿hasta cuándo?',
    '/nVuélvete, oh Jehová, libra mi alma; /nSálvame por tu misericordia.',
    ...
    '/nJehová ha oído mi ruego; /nHa recibido Jehová mi oración.',
    '/nSe avergonzarán y se turbarán mucho todos mis enemigos; /nSe volverán y serán avergonzados de repente.'
  ],
  [
    ...
    '/nMi escudo está en Dios, /nQue salva a los rectos de corazón.',
    '/nDios es juez justo, /nY Dios está airado contra el impío todos los días.',
    '/nSi no se arrepiente, él afilará su espada; /nArmado tiene ya su arco, y lo ha preparado.',
    '/nAsimismo ha preparado armas de muerte, /nY ha labrado saetas ardientes.',
    '/nHe aquí, el impío concibió maldad, /nSe preñó de iniquidad, /nY dio a luz engaño.',
    '/nPozo ha cavado, y lo ha ahondado; /nY en el hoyo que hizo caerá.',
    '/nSu iniquidad volverá sobre su cabeza, /nY su agravio caerá sobre su propia coronilla.',
  ...
  [
    ...
    '/nDigo: ¿Qué es el hombre, para que tengas de él memoria, /nY el hijo del hombre, para que lo visites?',
    '/nLe has hecho poco menor que los ángeles, /nY lo coronaste de gloria y de honra.',
    '/nLe hiciste señorear sobre las obras de tus manos; /nTodo lo pusiste debajo de sus pies:',
    '/nOvejas y bueyes, todo ello, /nY asimismo las bestias del campo,',
    '/nLas aves de los cielos y los peces del mar; /nTodo cuanto pasa por los senderos del mar.',
  ...
  [
    ...
    '/nMe alegraré y me regocijaré en ti; /nCantaré a tu nombre, oh Altísimo.',
    '/nMis enemigos volvieron atrás; /nCayeron y perecieron delante de ti.',
    '/nPorque has mantenido mi derecho y mi causa; /nTe has sentado en el trono juzgando con justicia.',
    '/nReprendiste a las naciones, destruiste al malo, /nBorraste el nombre de ellos eternamente y para siempre.',
    ...
    '/nJehová será refugio del pobre, /nRefugio para el tiempo de angustia.',
    '/nEn ti confiarán los que conocen tu nombre, /nPor cuanto tú, oh Jehová, no desamparaste a los que te buscaron.',
    '/nCantad a Jehová, que habita en Sion; /nPublicad entre los pueblos sus obras.',
    ...
    '/nSe hundieron las naciones en el hoyo que hicieron; /nEn la red que escondieron fue tomado su pie.',
    ...
    '/nPorque no para siempre será olvidado el menesteroso, /nNi la esperanza de los pobres perecerá perpetuamente.',
    '/nLevántate, oh Jehová; no se fortalezca el hombre; /nSean juzgadas las naciones delante de ti.',
    '/nPon, oh Jehová, temor en ellos; /nConozcan las naciones que no son sino hombres. Selah'
  ],
  [
    '/n¿Por qué estás lejos, oh Jehová, /nY te escondes en el tiempo de la tribulación?',
    '/nCon arrogancia el malo persigue al pobre; /nSerá atrapado en los artificios que ha ideado.',
    ...
    '/nSus caminos son torcidos en todo tiempo; /nTus juicios los tiene muy lejos de su vista; /nA todos sus adversarios desprecia.',
    '/nDice en su corazón: No seré movido jamás; /nNunca me alcanzará el infortunio.',
    '/nLlena está su boca de maldición, y de engaños y fraude; /nDebajo de su lengua hay vejación y maldad.',
    ...
    '/nSe encoge, se agacha, /nY caen en sus fuertes garras muchos desdichados.',
    ...
    '/n¿Por qué desprecia el malo a Dios? /nEn su corazón ha dicho: Tú no lo inquirirás.',
    ...
    '/nJehová es Rey eternamente y para siempre; /nDe su tierra han perecido las naciones.',
    '/nEl deseo de los humildes oíste, oh Jehová; /nTú dispones su corazón, y haces atento tu oído,',
  ...
  [
    ...
    '/nPorque he aquí, los malos tienden el arco, /nDisponen sus saetas sobre la cuerda, /nPara asaetear en oculto a los rectos de corazón.',
    '/nSi fueren destruidos los fundamentos, /n¿Qué ha de hacer el justo?',
    ...
    '/nJehová prueba al justo; /nPero al malo y al que ama la violencia, su alma los aborrece.',
  ...
  [
    ...
    '/nLas palabras de Jehová son palabras limpias, /nComo plata refinada en horno de tierra, /nPurificada siete veces.',
    '/nTú, Jehová, los guardarás; /nDe esta generación los preservarás para siempre.',
    '/nCercando andan los malos, /nCuando la vileza es exaltada entre los hijos de los hombres.'
  ],
  [
    '/n¿Hasta cuándo, Jehová? ¿Me olvidarás para siempre? /n¿Hasta cuándo esconderás tu rostro de mí?',
    '/n¿Hasta cuándo pondré consejos en mi alma, /nCon tristezas en mi corazón cada día? /n¿Hasta cuándo será enaltecido mi enemigo sobre mí?',
    ...
    '/nCantaré a Jehová, /nPorque me ha hecho bien.'
  ],
  [
    '/nDice el necio en su corazón: /nNo hay Dios. /nSe han corrompido, hacen obras abominables; /nNo hay quien haga el bien.',
    '/nJehová miró desde los cielos sobre los hijos de los hombres, /nPara ver si había algún entendido, /nQue buscara a Dios.',
    '/nTodos se desviaron, a una se han corrompido; /nNo hay quien haga lo bueno, no hay ni siquiera uno.',
    '/n¿No tienen discernimiento todos los que hacen iniquidad, /nQue devoran a mi pueblo como si comiesen pan, /nY a Jehová no invocan?',
    '/nEllos temblaron de espanto; /nPorque Dios está con la generación de los justos.',
    '/nDel consejo del pobre se han burlado, /nPero Jehová es su esperanza.',
  ...
  [
    '/nGuárdame, oh Dios, porque en ti he confiado.',
    ...
    '/nMe mostrarás la senda de la vida; /nEn tu presencia hay plenitud de gozo; /nDelicias a tu diestra para siempre.'
  ],
  [
    ...
    '/nSustenta mis pasos en tus caminos, /nPara que mis pies no resbalen.',
    '/nYo te he invocado, por cuanto tú me oirás, oh Dios; /nInclina a mí tu oído, escucha mi palabra.',
    '/nMuestra tus maravillosas misericordias, tú que salvas a los que se refugian a tu diestra, /nDe los que se levantan contra ellos.',
    ...
    '/nEnvueltos están con su grosura; /nCon su boca hablan arrogantemente.',
    ...
    '/nLevántate, oh Jehová; /nSal a su encuentro, póstrales; /nLibra mi alma de los malos con tu espada,',
  ...
  [
    ...
    '/nInvocaré a Jehová, quien es digno de ser alabado, /nY seré salvo de mis enemigos.',
    '/nMe rodearon ligaduras de muerte, /nY torrentes de perversidad me atemorizaron.',
    '/nLigaduras del Seol me rodearon, /nMe tendieron lazos de muerte.',
    ...
    '/nLa tierra fue conmovida y tembló; /nSe conmovieron los cimientos de los montes, /nY se estremecieron, porque se indignó él.',
    '/nHumo subió de su nariz, /nY de su boca fuego consumidor; /nCarbones fueron por él encendidos.',
    '/nInclinó los cielos, y descendió; /nY había densas tinieblas debajo de sus pies.',
    '/nCabalgó sobre un querubín, y voló; /nVoló sobre las alas del viento.',
    '/nPuso tinieblas por su escondedero, por cortina suya alrededor de sí; /nOscuridad de aguas, nubes de los cielos.',
    '/nPor el resplandor de su presencia, sus nubes pasaron; /nGranizo y carbones ardientes.',
    '/nTronó en los cielos Jehová, /nY el Altísimo dio su voz; /nGranizo y carbones de fuego.',
    '/nEnvió sus saetas, y los dispersó; /nLanzó relámpagos, y los destruyó.',
    ...
    '/nMe libró de mi poderoso enemigo, /nY de los que me aborrecían; pues eran más fuertes que yo.',
    '/nMe asaltaron en el día de mi quebranto, /nMas Jehová fue mi apoyo.',
    '/nMe sacó a lugar espacioso; /nMe libró, porque se agradó de mí.',
    '/nJehová me ha premiado conforme a mi justicia; /nConforme a la limpieza de mis manos me ha recompensado.',
    '/nPorque yo he guardado los caminos de Jehová, /nY no me aparté impíamente de mi Dios.',
    '/nPues todos sus juicios estuvieron delante de mí, /nY no me he apartado de sus estatutos.',
    '/nFui recto para con él, y me he guardado de mi maldad,',
    '/nPor lo cual me ha recompensado Jehová conforme a mi justicia; /nConforme a la limpieza de mis manos delante de su vista.',
    '/nCon el misericordioso te mostrarás misericordioso, /nY recto para con el hombre íntegro.',
    '/nLimpio te mostrarás para con el limpio, /nY severo serás para con el perverso.',
    '/nPorque tú salvarás al pueblo afligido, /nY humillarás los ojos altivos.',
    '/nTú encenderás mi lámpara; /nJehová mi Dios alumbrará mis tinieblas.',
    '/nContigo desbarataré ejércitos, /nY con mi Dios asaltaré muros.',
    '/nEn cuanto a Dios, perfecto es su camino, /nY acrisolada la palabra de Jehová; /nEscudo es a todos los que en él esperan.',
    '/nPorque ¿quién es Dios sino sólo Jehová? /n¿Y qué roca hay fuera de nuestro Dios?',
    '/nDios es el que me ciñe de poder, /nY quien hace perfecto mi camino;',
    '/nQuien hace mis pies como de ciervas, /nY me hace estar firme sobre mis alturas;',
    '/nQuien adiestra mis manos para la batalla, /nPara entesar con mis brazos el arco de bronce.',
    '/nMe diste asimismo el escudo de tu salvación; /nTu diestra me sustentó, /nY tu benignidad me ha engrandecido.',
    '/nEnsanchaste mis pasos debajo de mí, /nY mis pies no han resbalado.',
    '/nPerseguí a mis enemigos, y los alcancé, /nY no volví hasta acabarlos.',
    '/nLos herí de modo que no se levantasen; /nCayeron debajo de mis pies.',
    '/nPues me ceñiste de fuerzas para la pelea; /nHas humillado a mis enemigos debajo de mí.',
    '/nHas hecho que mis enemigos me vuelvan las espaldas, /nPara que yo destruya a los que me aborrecen.',
    ...
    '/nAl oír de mí me obedecieron; /nLos hijos de extraños se sometieron a mí.',
    '/nLos extraños se debilitaron /nY salieron temblando de sus encierros.',
    '/nViva Jehová, y bendita sea mi roca, /nY enaltecido sea el Dios de mi salvación;',
    ...
    '/nPor tanto yo te confesaré entre las naciones, oh Jehová, /nY cantaré a tu nombre.',
    '/nGrandes triunfos da a su rey, /nY hace misericordia a su ungido, /nA David y a su descendencia, para siempre.'
  ],
  [
    '/nLos cielos cuentan la gloria de Dios, /nY el firmamento anuncia la obra de sus manos.',
    '/nUn día emite palabra a otro día, /nY una noche a otra noche declara sabiduría.',
    '/nNo hay lenguaje, ni palabras, /nNi es oída su voz.',
    '/nPor toda la tierra salió su voz, /nY hasta el extremo del mundo sus palabras. /nEn ellos puso tabernáculo para el sol;',
    ...
    '/nLa ley de Jehová es perfecta, que convierte el alma; /nEl testimonio de Jehová es fiel, que hace sabio al sencillo.',
    '/nLos mandamientos de Jehová son rectos, que alegran el corazón; /nEl precepto de Jehová es puro, que alumbra los ojos.',
    '/nEl temor de Jehová es limpio, que permanece para siempre; /nLos juicios de Jehová son verdad, todos justos.',
    '/nDeseables son más que el oro, y más que mucho oro afinado; /nY dulces más que miel, y que la que destila del panal.',
    ...
    '/nPreserva también a tu siervo de las soberbias; /nQue no se enseñoreen de mí; /nEntonces seré íntegro, y estaré limpio de gran rebelión.',
    '/nSean gratos los dichos de mi boca y la meditación de mi corazón delante de ti, /nOh Jehová, roca mía, y redentor mío.'
  ],
  [
    '/nJehová te oiga en el día de conflicto; /nEl nombre del Dios de Jacob te defienda.',
    '/nTe envíe ayuda desde el santuario, /nY desde Sion te sostenga.',
    '/nHaga memoria de todas tus ofrendas, /nY acepte tu holocausto. Selah',
    '/nTe dé conforme al deseo de tu corazón, /nY cumpla todo tu consejo.',
    ...
    '/nEllos flaquean y caen, /nMas nosotros nos levantamos, y estamos en pie.',
  ...
  [
    ...
    '/nPorque le has salido al encuentro con bendiciones de bien; /nCorona de oro fino has puesto sobre su cabeza.',
    ...
    '/nPorque lo has bendecido para siempre; /nLo llenaste de alegría con tu presencia.',
    '/nPor cuanto el rey confía en Jehová, /nY en la misericordia del Altísimo, no será conmovido.',
    '/nAlcanzará tu mano a todos tus enemigos; /nTu diestra alcanzará a los que te aborrecen.',
    ...
    '/nPorque intentaron el mal contra ti; /nFraguaron maquinaciones, mas no prevalecerán,',
    '/nPues tú los pondrás en fuga; /nEn tus cuerdas dispondrás saetas contra sus rostros.',
    '/nEngrandécete, oh Jehová, en tu poder; /nCantaremos y alabaremos tu poderío.'
  ],
  [
    ...
    '/nMas yo soy gusano, y no hombre; /nOprobio de los hombres, y despreciado del pueblo.',
    ...
    '/nPero tú eres el que me sacó del vientre; /nEl que me hizo estar confiado desde que estaba a los pechos de mi madre.',
    ...
    '/nMe han rodeado muchos toros; /nFuertes toros de Basán me han cercado.',
    '/nAbrieron sobre mí su boca /nComo león rapaz y rugiente.',
    ...
    '/nLa posteridad le servirá; /nEsto será contado de Jehová hasta la postrera generación.',
    '/nVendrán, y anunciarán su justicia; /nA pueblo no nacido aún, anunciarán que él hizo esto.'
  ],
  [
    '/nJehová es mi pastor; nada me faltará.',
  ...
  [
    ...
    '/nPorque él la fundó sobre los mares, /nY la afirmó sobre los ríos.',
    '/n¿Quién subirá al monte de Jehová? /n¿Y quién estará en su lugar santo?',
    '/nEl limpio de manos y puro de corazón; /nEl que no ha elevado su alma a cosas vanas, /nNi jurado con engaño.',
    '/nEl recibirá bendición de Jehová, /nY justicia del Dios de salvación.',
    '/nTal es la generación de los que le buscan, /nDe los que buscan tu rostro, oh Dios de Jacob. Selah',
    '/nAlzad, oh puertas, vuestras cabezas, /nY alzaos vosotras, puertas eternas, /nY entrará el Rey de gloria.',
    '/n¿Quién es este Rey de gloria? /nJehová el fuerte y valiente, /nJehová el poderoso en batalla.',
    '/nAlzad, oh puertas, vuestras cabezas, /nY alzaos vosotras, puertas eternas, /nY entrará el Rey de gloria.',
    '/n¿Quién es este Rey de gloria? /nJehová de los ejércitos, /nEl es el Rey de la gloria. Selah'
  ],
  [
    ...
    '/nMuéstrame, oh Jehová, tus caminos; /nEnséñame tus sendas.',
    ...
    '/nDe los pecados de mi juventud, y de mis rebeliones, no te acuerdes; /nConforme a tu misericordia acuérdate de mí, /nPor tu bondad, oh Jehová.',
    ...
    '/nPor amor de tu nombre, oh Jehová, /nPerdonarás también mi pecado, que es grande.',
    '/n¿Quién es el hombre que teme a Jehová? /nEl le enseñará el camino que ha de escoger.',
    ...
    '/nMira mi aflicción y mi trabajo, /nY perdona todos mis pecados.',
    ...
    '/nRedime, oh Dios, a Israel /nDe todas sus angustias.'
  ],
  [
    ...
    '/nPorque tu misericordia está delante de mis ojos, /nY ando en tu verdad.',
    '/nNo me he sentado con hombres hipócritas, /nNi entré con los que andan simuladamente.',
    '/nAborrecí la reunión de los malignos, /nY con los impíos nunca me senté.',
  ...
  [
    '/nJehová es mi luz y mi salvación; ¿de quién temeré? /nJehová es la fortaleza de mi vida; ¿de quién he de atemorizarme?',
    '/nCuando se juntaron contra mí los malignos, mis angustiadores y mis enemigos, /nPara comer mis carnes, ellos tropezaron y cayeron.',
    '/nAunque un ejército acampe contra mí, /nNo temerá mi corazón; /nAunque contra mí se levante guerra, /nYo estaré confiado.',
    '/nUna cosa he demandado a Jehová, ésta buscaré; /nQue esté yo en la casa de Jehová todos los días de mi vida, /nPara contemplar la hermosura de Jehová, y para inquirir en su templo.',
    '/nPorque él me esconderá en su tabernáculo en el día del mal; /nMe ocultará en lo reservado de su morada; /nSobre una roca me pondrá en alto.',
    ...
    '/nMi corazón ha dicho de ti: Buscad mi rostro. /nTu rostro buscaré, oh Jehová;',
    ...
    '/nHubiera yo desmayado, si no creyese que veré la bondad de Jehová /nEn la tierra de los vivientes.',
  ...
  [
    ...
    '/nOye la voz de mis ruegos cuando clamo a ti, /nCuando alzo mis manos hacia tu santo templo.',
    ...
    '/nJehová es mi fortaleza y mi escudo; /nEn él confió mi corazón, y fui ayudado, /nPor lo que se gozó mi corazón, /nY con mi cántico le alabaré.',
    '/nJehová es la fortaleza de su pueblo, /nY el refugio salvador de su ungido.',
    '/nSalva a tu pueblo, y bendice a tu heredad; /nY pastoréales y susténtales para siempre.'
  ],
  [
    '/nTributad a Jehová, oh hijos de los poderosos, /nDad a Jehová la gloria y el poder.',
    '/nDad a Jehová la gloria debida a su nombre; /nAdorad a Jehová en la hermosura de la santidad.',
    '/nVoz de Jehová sobre las aguas; /nTruena el Dios de gloria, /nJehová sobre las muchas aguas.',
    '/nVoz de Jehová con potencia; /nVoz de Jehová con gloria.',
    '/nVoz de Jehová que quebranta los cedros; /nQuebrantó Jehová los cedros del Líbano.',
    '/nLos hizo saltar como becerros; /nAl Líbano y al Sirión como hijos de búfalos.',
    '/nVoz de Jehová que derrama llamas de fuego;',
    '/nVoz de Jehová que hace temblar el desierto; /nHace temblar Jehová el desierto de Cades.',
    '/nVoz de Jehová que desgaja las encinas, /nY desnuda los bosques; /nEn su templo todo proclama su gloria.',
    '/nJehová preside en el diluvio, /nY se sienta Jehová como rey para siempre.',
  ...
  [
    ...
    '/nJehová Dios mío, /nA ti clamé, y me sanaste.',
    '/nOh Jehová, hiciste subir mi alma del Seol; /nMe diste vida, para que no descendiese a la sepultura.',
    '/nCantad a Jehová, vosotros sus santos, /nY celebrad la memoria de su santidad.',
  ...
  [
    ...
    '/nInclina a mí tu oído, líbrame pronto; /nSé tú mi roca fuerte, y fortaleza para salvarme.',
    '/nPorque tú eres mi roca y mi castillo; /nPor tu nombre me guiarás y me encaminarás.',
    '/nSácame de la red que han escondido para mí, /nPues tú eres mi refugio.',
    '/nEn tu mano encomiendo mi espíritu; /nTú me has redimido, oh Jehová, Dios de verdad.',
    ...
    '/nDe todos mis enemigos soy objeto de oprobio, /nY de mis vecinos mucho más, y el horror de mis conocidos; /nLos que me ven fuera huyen de mí.',
    ...
    '/nMas yo en ti confío, oh Jehová; /nDigo: Tú eres mi Dios.',
    ...
    '/nEnmudezcan los labios mentirosos, /nQue hablan contra el justo cosas duras /nCon soberbia y menosprecio.',
    ...
    '/nEsforzaos todos vosotros los que esperáis en Jehová, /nY tome aliento vuestro corazón.'
  ],
  [
    '/nBienaventurado aquel cuya transgresión ha sido perdonada, y cubierto su pecado.',
    ...
    '/nPor esto orará a ti todo santo en el tiempo en que puedas ser hallado; /nCiertamente en la inundación de muchas aguas no llegarán éstas a él.',
  ...
  [
    '/nAlegraos, oh justos, en Jehová; /nEn los íntegros es hermosa la alabanza.',
    '/nAclamad a Jehová con arpa; /nCantadle con salterio y decacordio.',
    '/nCantadle cántico nuevo; /nHacedlo bien, tañendo con júbilo.',
    '/nPorque recta es la palabra de Jehová, /nY toda su obra es hecha con fidelidad.',
    '/nEl ama justicia y juicio; /nDe la misericordia de Jehová está llena la tierra.',
    '/nPor la palabra de Jehová fueron hechos los cielos, /nY todo el ejército de ellos por el aliento de su boca.',
    ...
    '/nPorque él dijo, y fue hecho; /nEl mandó, y existió.',
    '/nJehová hace nulo el consejo de las naciones, /nY frustra las maquinaciones de los pueblos.',
    '/nEl consejo de Jehová permanecerá para siempre; /nLos pensamientos de su corazón por todas las generaciones.',
    ...
    '/nDesde el lugar de su morada miró /nSobre todos los moradores de la tierra.',
    '/nEl formó el corazón de todos ellos; /nAtento está a todas sus obras.',
    ...
    '/nHe aquí el ojo de Jehová sobre los que le temen, /nSobre los que esperan en su misericordia,',
    '/nPara librar sus almas de la muerte, /nY para darles vida en tiempo de hambre.',
    '/nNuestra alma espera a Jehová; /nNuestra ayuda y nuestro escudo es él.',
    '/nPor tanto, en él se alegrará nuestro corazón, /nPorque en su santo nombre hemos confiado.',
  ...
  [
    ...
    '/nEn Jehová se gloriará mi alma; /nLo oirán los mansos, y se alegrarán.',
    '/nEngrandeced a Jehová conmigo, /nY exaltemos a una su nombre.',
    '/nBusqué a Jehová, y él me oyó, /nY me libró de todos mis temores.',
    '/nLos que miraron a él fueron alumbrados, /nY sus rostros no fueron avergonzados.',
    '/nEste pobre clamó, y le oyó Jehová, /nY lo libró de todas sus angustias.',
    ...
    '/nTemed a Jehová, vosotros sus santos, /nPues nada falta a los que le temen.',
    '/nLos leoncillos necesitan, y tienen hambre; /nPero los que buscan a Jehová no tendrán falta de ningún bien.',
    '/nVenid, hijos, oídme; /nEl temor de Jehová os enseñaré.',
    '/n¿Quién es el hombre que desea vida, /nQue desea muchos días para ver el bien?',
    '/nGuarda tu lengua del mal, /nY tus labios de hablar engaño.',
    '/nApártate del mal, y haz el bien; /nBusca la paz, y síguela.',
    '/nLos ojos de Jehová están sobre los justos, /nY atentos sus oídos al clamor de ellos.',
    '/nLa ira de Jehová contra los que hacen mal, /nPara cortar de la tierra la memoria de ellos.',
    '/nClaman los justos, y Jehová oye, /nY los libra de todas sus angustias.',
    '/nCercano está Jehová a los quebrantados de corazón; /nY salva a los contritos de espíritu.',
    '/nMuchas son las aflicciones del justo, /nPero de todas ellas le librará Jehová.',
    '/nEl guarda todos sus huesos; /nNi uno de ellos será quebrantado.',
    '/nMatará al malo la maldad, /nY los que aborrecen al justo serán condenados.',
    '/nJehová redime el alma de sus siervos, /nY no serán condenados cuantos en él confían.'
  ],
  [
    '/nDisputa, oh Jehová, con los que contra mí contienden; /nPelea contra los que me combaten.',
    '/nEcha mano al escudo y al pavés, /nY levántate en mi ayuda.',
    ...
    '/nSean como el tamo delante del viento, /nY el ángel de Jehová los acose.',
    '/nSea su camino tenebroso y resbaladizo, /nY el ángel de Jehová los persiga.',
    ...
    '/nSe levantan testigos malvados; /nDe lo que no sé me preguntan;',
    ...
    '/nTú lo has visto, oh Jehová; no calles; /nSeñor, no te alejes de mí.',
    '/nMuévete y despierta para hacerme justicia, /nDios mío y Señor mío, para defender mi causa.',
    ...
    '/nY mi lengua hablará de tu justicia /nY de tu alabanza todo el día.'
  ],
  [
    ...
    '/nPorque contigo está el manantial de la vida; /nEn tu luz veremos la luz.',
    ...
    '/nAllí cayeron los hacedores de iniquidad; /nFueron derribados, y no podrán levantarse.'
  ],
  [
    '/nNo te impacientes a causa de los malignos, /nNi tengas envidia de los que hacen iniquidad.',
    '/nPorque como hierba serán pronto cortados, /nY como la hierba verde se secarán.',
    '/nConfía en Jehová, y haz el bien; /nY habitarás en la tierra, y te apacentarás de la verdad.',
    '/nDeléitate asimismo en Jehová, /nY él te concederá las peticiones de tu corazón.',
    ...
    '/nDeja la ira, y desecha el enojo; /nNo te excites en manera alguna a hacer lo malo.',
    ...
    '/nPero los mansos heredarán la tierra, /nY se recrearán con abundancia de paz.',
    '/nMaquina el impío contra el justo, /nY cruje contra él sus dientes;',
    '/nEl Señor se reirá de él; /nPorque ve que viene su día.',
    '/nLos impíos desenvainan espada y entesan su arco, /nPara derribar al pobre y al menesteroso, /nPara matar a los de recto proceder.',
    '/nSu espada entrará en su mismo corazón, /nY su arco será quebrado.',
    '/nMejor es lo poco del justo, /nQue las riquezas de muchos pecadores.',
    '/nPorque los brazos de los impíos serán quebrados; /nMas el que sostiene a los justos es Jehová.',
    ...
    '/nPorque los benditos de él heredarán la tierra; /nY los malditos de él serán destruidos.',
    ...
    '/nEn todo tiempo tiene misericordia, y presta; /nY su descendencia es para bendición.',
    ...
    '/nLos justos heredarán la tierra, /nY vivirán para siempre sobre ella.',
    '/nLa boca del justo habla sabiduría, /nY su lengua habla justicia.',
    '/nLa ley de su Dios está en su corazón; /nPor tanto, sus pies no resbalarán.',
    '/nAcecha el impío al justo, /nY procura matarlo.',
    ...
    '/nVi yo al impío sumamente enaltecido, /nY que se extendía como laurel verde.',
    '/nPero él pasó, y he aquí ya no estaba; /nLo busqué, y no fue hallado.',
    '/nConsidera al íntegro, y mira al justo; /nPorque hay un final dichoso para el hombre de paz.',
    '/nMas los transgresores serán todos a una destruidos; /nLa posteridad de los impíos será extinguida.',
    '/nPero la salvación de los justos es de Jehová, /nY él es su fortaleza en el tiempo de la angustia.',
  ...
  [
    ...
    '/nPorque tus saetas cayeron sobre mí, /nY sobre mí ha descendido tu mano.',
    '/nNada hay sano en mi carne, a causa de tu ira; /nNi hay paz en mis huesos, a causa de mi pecado.',
    '/nPorque mis iniquidades se han agravado sobre mi cabeza; /nComo carga pesada se han agravado sobre mí.',
    '/nHieden y supuran mis llagas, /nA causa de mi locura.',
    '/nEstoy encorvado, estoy humillado en gran manera, /nAndo enlutado todo el día.',
    '/nPorque mis lomos están llenos de ardor, /nY nada hay sano en mi carne.',
    '/nEstoy debilitado y molido en gran manera; /nGimo a causa de la conmoción de mi corazón.',
    '/nSeñor, delante de ti están todos mis deseos, /nY mi suspiro no te es oculto.',
    ...
    '/nMas yo, como si fuera sordo, no oigo; /nY soy como mudo que no abre la boca.',
    '/nSoy, pues, como un hombre que no oye, /nY en cuya boca no hay reprensiones.',
    ...
    '/nPero yo estoy a punto de caer, /nY mi dolor está delante de mí continuamente.',
    '/nPor tanto, confesaré mi maldad, /nY me contristaré por mi pecado.',
    '/nPorque mis enemigos están vivos y fuertes, /nY se han aumentado los que me aborrecen sin causa.',
    ...
    '/nApresúrate a ayudarme, /nOh Señor, mi salvación.'
  ],
  [
    ...
    '/nY ahora, Señor, ¿qué esperaré? /nMi esperanza está en ti.',
    '/nLíbrame de todas mis transgresiones; /nNo me pongas por escarnio del insensato.',
    '/nEnmudecí, no abrí mi boca, /nPorque tú lo hiciste.',
    ...
    '/nOye mi oración, oh Jehová, y escucha mi clamor. /nNo calles ante mis lágrimas; /nPorque forastero soy para ti, /nY advenedizo, como todos mis padres.',
    '/nDéjame, y tomaré fuerzas, /nAntes que vaya y perezca.'
  ],
  [
    '/nPacientemente esperé a Jehová, /nY se inclinó a mí, y oyó mi clamor.',
    '/nY me hizo sacar del pozo de la desesperación, del lodo cenagoso; /nPuso mis pies sobre peña, y enderezó mis pasos.',
    '/nPuso luego en mi boca cántico nuevo, alabanza a nuestro Dios. /nVerán esto muchos, y temerán, /nY confiarán en Jehová.',
    ...
    '/nHas aumentado, oh Jehová Dios mío, tus maravillas; /nY tus pensamientos para con nosotros, /nNo es posible contarlos ante ti. /nSi yo anunciare y hablare de ellos, /nNo pueden ser enumerados.',
    '/nSacrificio y ofrenda no te agrada; /nHas abierto mis oídos; /nHolocausto y expiación no has demandado.',
    '/nEntonces dije: He aquí, vengo; /nEn el rollo del libro está escrito de mí;',
    '/nEl hacer tu voluntad, Dios mío, me ha agradado, /nY tu ley está en medio de mi corazón.',
    '/nHe anunciado justicia en grande congregación; /nHe aquí, no refrené mis labios, /nJehová, tú lo sabes.',
    '/nNo encubrí tu justicia dentro de mi corazón; /nHe publicado tu fidelidad y tu salvación; /nNo oculté tu misericordia y tu verdad en grande asamblea.',
    '/nJehová, no retengas de mí tus misericordias; /nTu misericordia y tu verdad me guarden siempre.',
    '/nPorque me han rodeado males sin número; /nMe han alcanzado mis maldades, y no puedo levantar la vista. /nSe han aumentado más que los cabellos de mi cabeza, y mi corazón me falla.',
    '/nQuieras, oh Jehová, librarme; /nJehová, apresúrate a socorrerme.',
    ...
    '/nSean asolados en pago de su afrenta /nLos que me dicen: ¡Ea, ea!',
    '/nGócense y alégrense en ti todos los que te buscan, /nY digan siempre los que aman tu salvación: /nJehová sea enaltecido.',
  ...
  [
    ...
    '/nCosa pestilencial se ha apoderado de él; /nY el que cayó en cama no volverá a levantarse.',
    '/nAun el hombre de mi paz, en quien yo confiaba, el que de mi pan comía, /nAlzó contra mí el calcañar.',
    '/nMas tú, Jehová, ten misericordia de mí, y hazme levantar, /nY les daré el pago.',
  ...
  [
    ...
    '/nDiré a Dios: Roca mía, ¿por qué te has olvidado de mí? /n¿Por qué andaré yo enlutado por la opresión del enemigo?',
  ...
  [
    '/nJúzgame, oh Dios, y defiende mi causa; /nLíbrame de gente impía, y del hombre engañoso e inicuo.',
    ...
    '/nEntraré al altar de Dios, /nAl Dios de mi alegría y de mi gozo; /nY te alabaré con arpa, oh Dios, Dios mío.',
    '/n¿Por qué te abates, oh alma mía, /nY por qué te turbas dentro de mí? /nEspera en Dios; porque aún he de alabarle, /nSalvación mía y Dios mío.'
  ],
  [
    ...
    '/nPorque no se apoderaron de la tierra por su espada, /nNi su brazo los libró; /nSino tu diestra, y tu brazo, y la luz de tu rostro, /nPorque te complaciste en ellos.',
    '/nTú, oh Dios, eres mi rey; /nManda salvación a Jacob.',
    '/nPor medio de ti sacudiremos a nuestros enemigos; /nEn tu nombre hollaremos a nuestros adversarios.',
    '/nPorque no confiaré en mi arco, /nNi mi espada me salvará;',
    ...
    '/nNos hiciste retroceder delante del enemigo, /nY nos saquean para sí los que nos aborrecen.',
    '/nNos entregas como ovejas al matadero, /nY nos has esparcido entre las naciones.',
    '/nHas vendido a tu pueblo de balde; /nNo exigiste ningún precio.',
    '/nNos pones por afrenta de nuestros vecinos, /nPor escarnio y por burla de los que nos rodean.',
    '/nNos pusiste por proverbio entre las naciones; /nTodos al vernos menean la cabeza.',
    '/nCada día mi vergüenza está delante de mí, /nY la confusión de mi rostro me cubre,',
    '/nPor la voz del que me vitupera y deshonra, /nPor razón del enemigo y del vengativo.',
    '/nTodo esto nos ha venido, y no nos hemos olvidado de ti, /nY no hemos faltado a tu pacto.',
    '/nNo se ha vuelto atrás nuestro corazón, /nNi se han apartado de tus caminos nuestros pasos,',
    '/nPara que nos quebrantases en el lugar de chacales, /nY nos cubrieses con sombra de muerte.',
    '/nSi nos hubiésemos olvidado del nombre de nuestro Dios, /nO alzado nuestras manos a dios ajeno,',
    '/n¿No demandaría Dios esto? /nPorque él conoce los secretos del corazón.',
    '/nPero por causa de ti nos matan cada día; /nSomos contados como ovejas para el matadero.',
    '/nDespierta; ¿por qué duermes, Señor? /nDespierta, no te alejes para siempre.',
    '/n¿Por qué escondes tu rostro, /nY te olvidas de nuestra aflicción, y de la opresión nuestra?',
    '/nPorque nuestra alma está agobiada hasta el polvo, /nY nuestro cuerpo está postrado hasta la tierra.',
    '/nLevántate para ayudarnos, /nY redímenos por causa de tu misericordia.'
  ],
  [
    '/nRebosa mi corazón palabra buena; /nDirijo al rey mi canto; /nMi lengua es pluma de escribiente muy ligero.',
    ...
    '/nTu trono, oh Dios, es eterno y para siempre; /nCetro de justicia es el cetro de tu reino.',
    ...
    '/nY las hijas de Tiro vendrán con presentes; /nImplorarán tu favor los ricos del pueblo.',
    '/nToda gloriosa es la hija del rey en su morada; /nDe brocado de oro es su vestido.',
    '/nCon vestidos bordados será llevada al rey; /nVírgenes irán en pos de ella, /nCompañeras suyas serán traídas a ti.',
    '/nSerán traídas con alegría y gozo; /nEntrarán en el palacio del rey.',
    '/nEn lugar de tus padres serán tus hijos, /nA quienes harás príncipes en toda la tierra.',
  ...
  [
    '/nDios es nuestro amparo y fortaleza, /nNuestro pronto auxilio en las tribulaciones.',
    ...
    '/nBramaron las naciones, titubearon los reinos; /nDio él su voz, se derritió la tierra.',
    '/nJehová de los ejércitos está con nosotros; /nNuestro refugio es el Dios de Jacob. Selah',
    '/nVenid, ved las obras de Jehová, /nQue ha puesto asolamientos en la tierra.',
    '/nQue hace cesar las guerras hasta los fines de la tierra. /nQue quiebra el arco, corta la lanza, /nY quema los carros en el fuego.',
  ...
  [
    ...
    '/nPorque Jehová el Altísimo es temible; /nRey grande sobre toda la tierra.',
    ...
    '/nSubió Dios con júbilo, /nJehová con sonido de trompeta.',
    '/nCantad a Dios, cantad; /nCantad a nuestro Rey, cantad;',
    '/nPorque Dios es el Rey de toda la tierra; /nCantad con inteligencia.',
    '/nReinó Dios sobre las naciones; /nSe sentó Dios sobre su santo trono.',
    '/nLos príncipes de los pueblos se reunieron /nComo pueblo del Dios de Abraham;',
    '/nPorque de Dios son los escudos de la tierra; /nEl es muy exaltado.'
  ],
  [
    '/nGrande es Jehová, y digno de ser en gran manera alabado /nEn la ciudad de nuestro Dios, en su monte santo.',
    '/nHermosa provincia, el gozo de toda la tierra, /nEs el monte de Sion, a los lados del norte, /nLa ciudad del gran Rey.',
    '/nEn sus palacios Dios es conocido por refugio.',
    '/nPorque he aquí los reyes de la tierra se reunieron; /nPasaron todos.',
    ...
    '/nCon viento solano /nQuiebras tú las naves de Tarsis.',
    ...
    '/nNos acordamos de tu misericordia, oh Dios, /nEn medio de tu templo.',
    ...
    '/nPorque este Dios es Dios nuestro eternamente y para siempre; /nEl nos guiará aun más allá de la muerte.'
  ],
  [
    '/nOíd esto, pueblos todos; /nEscuchad, habitantes todos del mundo,',
    '/nAsí los plebeyos como los nobles, /nEl rico y el pobre juntamente.',
    '/nMi boca hablará sabiduría, /nY el pensamiento de mi corazón inteligencia.',
    ...
    '/nLos que confían en sus bienes, /nY de la muchedumbre de sus riquezas se jactan,',
    '/nNinguno de ellos podrá en manera alguna redimir al hermano, /nNi dar a Dios su rescate',
    '/n(Porque la redención de su vida es de gran precio, /nY no se logrará jamás),',
    '/nPara que viva en adelante para siempre, /nY nunca vea corrupción.',
    ...
    '/nNo temas cuando se enriquece alguno, /nCuando aumenta la gloria de su casa;',
    '/nPorque cuando muera no llevará nada, /nNi descenderá tras él su gloria.',
    '/nAunque mientras viva, llame dichosa a su alma, /nY sea loado cuando prospere,',
    '/nEntrará en la generación de sus padres, /nY nunca más verá la luz.',
  ...
  [
    ...
    '/nDe Sion, perfección de hermosura, /nDios ha resplandecido.',
    '/nVendrá nuestro Dios, y no callará; /nFuego consumirá delante de él, /nY tempestad poderosa le rodeará.',
    '/nConvocará a los cielos de arriba, /nY a la tierra, para juzgar a su pueblo.',
    ...
    '/nPorque mía es toda bestia del bosque, /nY los millares de animales en los collados.',
    '/nConozco a todas las aves de los montes, /nY todo lo que se mueve en los campos me pertenece.',
    ...
    '/nSacrifica a Dios alabanza, /nY paga tus votos al Altísimo;',
    '/nE invócame en el día de la angustia; /nTe libraré, y tú me honrarás.',
    '/nPero al malo dijo Dios: /n¿Qué tienes tú que hablar de mis leyes, /nY que tomar mi pacto en tu boca?',
    '/nPues tú aborreces la corrección, /nY echas a tu espalda mis palabras.',
    '/nSi veías al ladrón, tú corrías con él, /nY con los adúlteros era tu parte.',
    '/nTu boca metías en mal, /nY tu lengua componía engaño.',
  ...
  [
    ...
    '/nLávame más y más de mi maldad, /nY límpiame de mi pecado.',
    '/nPorque yo reconozco mis rebeliones, /nY mi pecado está siempre delante de mí.',
    ...
    '/nHe aquí, en maldad he sido formado, /nY en pecado me concibió mi madre.',
    ...
    '/nEsconde tu rostro de mis pecados, /nY borra todas mis maldades.',
    '/nCrea en mí, oh Dios, un corazón limpio, /nY renueva un espíritu recto dentro de mí.',
    '/nNo me eches de delante de ti, /nY no quites de mí tu santo Espíritu.',
    '/nVuélveme el gozo de tu salvación, /nY espíritu noble me sustente.',
    '/nEntonces enseñaré a los transgresores tus caminos, /nY los pecadores se convertirán a ti.',
    '/nLíbrame de homicidios, oh Dios, Dios de mi salvación; /nCantará mi lengua tu justicia.',
    '/nSeñor, abre mis labios, /nY publicará mi boca tu alabanza.',
    '/nPorque no quieres sacrificio, que yo lo daría; /nNo quieres holocausto.',
    '/nLos sacrificios de Dios son el espíritu quebrantado; /nAl corazón contrito y humillado no despreciarás tú, oh Dios.',
    '/nHaz bien con tu benevolencia a Sion; /nEdifica los muros de Jerusalén.',
    '/nEntonces te agradarán los sacrificios de justicia, /nel holocausto u ofrenda del todo quemada; /nEntonces ofrecerán becerros sobre tu altar.'
  ],
  [
    '/n¿Por qué te jactas de maldad, oh poderoso? /nLa misericordia de Dios es continua.',
    '/nAgravios maquina tu lengua; /nComo navaja afilada hace engaño.',
    '/nAmaste el mal más que el bien, /nLa mentira más que la verdad. Selah',
    '/nHas amado toda suerte de palabras perniciosas, /nEngañosa lengua.',
    ...
    '/nVerán los justos, y temerán; /nSe reirán de él, diciendo:',
    ...
    '/nPero yo estoy como olivo verde en la casa de Dios; /nEn la misericordia de Dios confío eternamente y para siempre.',
  ...
  [
    ...
    '/nDios desde los cielos miró sobre los hijos de los hombres, /nPara ver si había algún entendido /nQue buscara a Dios.',
    '/nCada uno se había vuelto atrás; todos se habían corrompido; /nNo hay quien haga lo bueno, no hay ni aun uno.',
    ...
    '/nAllí se sobresaltaron de pavor donde no había miedo, /nPorque Dios ha esparcido los huesos del que puso asedio contra ti; /nLos avergonzaste, porque Dios los desechó.',
  ...
  [
    ...
    '/nOh Dios, oye mi oración; /nEscucha las razones de mi boca.',
    ...
    '/nHe aquí, Dios es el que me ayuda; /nEl Señor está con los que sostienen mi vida.',
  ...
  [
    ...
    '/nEstá atento, y respóndeme; /nClamo en mi oración, y me conmuevo,',
    ...
    '/nTemor y temblor vinieron sobre mí, /nY terror me ha cubierto.',
    ...
    '/nMe apresuraría a escapar /nDel viento borrascoso, de la tempestad.',
    ...
    '/nSino tú, hombre, al parecer íntimo mío, /nMi guía, y mi familiar;',
  ...
  [
    ...
    '/nTodo el día mis enemigos me pisotean; /nPorque muchos son los que pelean contra mí con soberbia.',
    '/nEn el día que temo, /nYo en ti confío.',
    ...
    '/nSobre mí, oh Dios, están tus votos; /nTe tributaré alabanzas.',
  ...
  [
    ...
    '/nPronto está mi corazón, oh Dios, mi corazón está dispuesto; /nCantaré, y trovaré salmos.',
    '/nDespierta, alma mía; despierta, salterio y arpa; /nMe levantaré de mañana.',
    '/nTe alabaré entre los pueblos, oh Señor; /nCantaré de ti entre las naciones.',
    '/nPorque grande es hasta los cielos tu misericordia, /nY hasta las nubes tu verdad.',
    '/nExaltado seas sobre los cielos, oh Dios; /nSobre toda la tierra sea tu gloria.'
  ],
  [
    ...
    '/nVeneno tienen como veneno de serpiente; /nSon como el áspid sordo que cierra su oído,',
    '/nQue no oye la voz de los que encantan, /nPor más hábil que el encantador sea.',
    '/nOh Dios, quiebra sus dientes en sus bocas; /nQuiebra, oh Jehová, las muelas de los leoncillos.',
    '/nSean disipados como aguas que corren; /nCuando disparen sus saetas, sean hechas pedazos.',
    ...
    '/nSe alegrará el justo cuando viere la venganza; /nSus pies lavará en la sangre del impío.',
  ...
  [
    ...
    '/nSin delito mío corren y se aperciben. /nDespierta para venir a mi encuentro, y mira.',
    ...
    '/nEl Dios de mi misericordia irá delante de mí; /nDios hará que vea en mis enemigos mi deseo.',
    '/nNo los mates, para que mi pueblo no olvide; /nDispérsalos con tu poder, y abátelos, /nOh Jehová, escudo nuestro.',
    '/nPor el pecado de su boca, por la palabra de sus labios, /nSean ellos presos en su soberbia, /nY por la maldición y mentira que profieren.',
    ...
    '/nFortaleza mía, a ti cantaré; /nPorque eres, oh Dios, mi refugio, el Dios de mi misericordia.'
  ],
  [
    '/nOh Dios, tú nos has desechado, nos quebrantaste; /nTe has airado; ¡vuélvete a nosotros!',
    ...
    '/nMoab, vasija para lavarme; /nSobre Edom echaré mi calzado; /nMe regocijaré sobre Filistea.',
    '/n¿Quién me llevará a la ciudad fortificada? /n¿Quién me llevará hasta Edom?',
    '/n¿No serás tú, oh Dios, que nos habías desechado, /nY no salías, oh Dios, con nuestros ejércitos?',
    '/nDanos socorro contra el enemigo, /nPorque vana es la ayuda de los hombres.',
    '/nEn Dios haremos proezas, /nY él hollará a nuestros enemigos.'
  ],
  [
    '/nOye, oh Dios, mi clamor; /nA mi oración atiende.',
    '/nDesde el cabo de la tierra clamaré a ti, cuando mi corazón desmayare. /nLlévame a la roca que es más alta que yo,',
    '/nPorque tú has sido mi refugio, /nY torre fuerte delante del enemigo.',
    ...
    '/nDías sobre días añadirás al rey; /nSus años serán como generación y generación.',
  ...
  [
    ...
    '/nEl solamente es mi roca y mi salvación; /nEs mi refugio, no resbalaré mucho.',
    ...
    '/nEl solamente es mi roca y mi salvación. /nEs mi refugio, no resbalaré.',
    '/nEn Dios está mi salvación y mi gloria; /nEn Dios está mi roca fuerte, y mi refugio.',
    ...
    '/nUna vez habló Dios; /nDos veces he oído esto: /nQue de Dios es el poder,',
  ...
  [
    ...
    '/nPara ver tu poder y tu gloria, /nAsí como te he mirado en el santuario.',
    ...
    '/nComo de meollo y de grosura será saciada mi alma, /nY con labios de júbilo te alabará mi boca,',
    '/nCuando me acuerde de ti en mi lecho, /nCuando medite en ti en las vigilias de la noche.',
    '/nPorque has sido mi socorro, /nY así en la sombra de tus alas me regocijaré.',
    '/nEstá mi alma apegada a ti; /nTu diestra me ha sostenido.',
    '/nPero los que para destrucción buscaron mi alma /nCaerán en los sitios bajos de la tierra.',
  ...
  [
    ...
    '/nEscóndeme del consejo secreto de los malignos, /nDe la conspiración de los que hacen iniquidad,',
    '/nQue afilan como espada su lengua; /nLanzan cual saeta suya, palabra amarga,',
    ...
    '/nInquieren iniquidades, hacen una investigación exacta; /nY el íntimo pensamiento de cada uno de ellos, así como su corazón, es profundo.',
    ...
    '/nEntonces temerán todos los hombres, /nY anunciarán la obra de Dios, /nY entenderán sus hechos.',
  ...
  [
    ...
    '/nTú oyes la oración; /nA ti vendrá toda carne.',
    ...
    '/nCon tremendas cosas nos responderás tú en justicia, /nOh Dios de nuestra salvación, /nEsperanza de todos los términos de la tierra, /nY de los más remotos confines del mar.',
    '/nTú, el que afirma los montes con su poder, /nCeñido de valentía;',
    ...
    '/nVisitas la tierra, y la riegas; /nEn gran manera la enriqueces; /nCon el río de Dios, lleno de aguas, /nPreparas el grano de ellos, cuando así la dispones.',
    '/nHaces que se empapen sus surcos, /nHaces descender sus canales; /nLa ablandas con lluvias, /nBendices sus renuevos.',
    '/nTú coronas el año con tus bienes, /nY tus nubes destilan grosura.',
    '/nDestilan sobre los pastizales del desierto, /nY los collados se ciñen de alegría.',
    '/nSe visten de manadas los llanos, /nY los valles se cubren de grano; /nDan voces de júbilo, y aun cantan.'
  ],
  [
    '/nAclamad a Dios con alegría, toda la tierra.',
    ...
    '/nToda la tierra te adorará, /nY cantará a ti; /nCantarán a tu nombre. Selah',
    '/nVenid, y ved las obras de Dios, /nTemible en hechos sobre los hijos de los hombres.',
    ...
    '/nBendecid, pueblos, a nuestro Dios, /nY haced oír la voz de su alabanza.',
    ...
    '/nNos metiste en la red; /nPusiste sobre nuestros lomos pesada carga.',
    ...
    '/nQue pronunciaron mis labios /nY habló mi boca, cuando estaba angustiado.',
    ...
    '/nVenid, oíd todos los que teméis a Dios, /nY contaré lo que ha hecho a mi alma.',
    '/nA él clamé con mi boca, /nY fue exaltado con mi lengua.',
    '/nSi en mi corazón hubiese yo mirado a la iniquidad, /nEl Señor no me habría escuchado.',
  ...
  [
    ...
    '/nPara que sea conocido en la tierra tu camino, /nEn todas las naciones tu salvación.',
    '/nTe alaben los pueblos, oh Dios; /nTodos los pueblos te alaben.',
    ...
    '/nTe alaben los pueblos, oh Dios; /nTodos los pueblos te alaben.',
    '/nLa tierra dará su fruto; /nNos bendecirá Dios, el Dios nuestro.',
  ...
  [
    ...
    '/nPadre de huérfanos y defensor de viudas /nEs Dios en su santa morada.',
    ...
    '/nOh Dios, cuando tú saliste delante de tu pueblo, /nCuando anduviste por el desierto, Selah',
    ...
    '/nMonte de Dios es el monte de Basán; /nMonte alto el de Basán.',
    ...
    '/nDios, nuestro Dios ha de salvarnos, /nY de Jehová el Señor es el librar de la muerte.',
    '/nCiertamente Dios herirá la cabeza de sus enemigos, /nLa testa cabelluda del que camina en sus pecados.',
    '/nEl Señor dijo: De Basán te haré volver; /nTe haré volver de las profundidades del mar;',
    '/nPorque tu pie se enrojecerá de sangre de tus enemigos, /nY de ella la lengua de tus perros.',
    '/nVieron tus caminos, oh Dios; /nLos caminos de mi Dios, de mi Rey, en el santuario.',
    ...
    '/nAllí estaba el joven Benjamín, señoreador de ellos, /nLos príncipes de Judá en su congregación, /nLos príncipes de Zabulón, los príncipes de Neftalí.',
    ...
    '/nVendrán príncipes de Egipto; /nEtiopía se apresurará a extender sus manos hacia Dios.',
    '/nReinos de la tierra, cantad a Dios, /nCantad al Señor; Selah',
    '/nAl que cabalga sobre los cielos de los cielos, que son desde la antigüedad; /nHe aquí dará su voz, poderosa voz.',
    '/nAtribuid poder a Dios; /nSobre Israel es su magnificencia, /nY su poder está en los cielos.',
  ...
  [
    ...
    '/nCansado estoy de llamar; mi garganta se ha enronquecido; /nHan desfallecido mis ojos esperando a mi Dios.',
    ...
    '/nNo escondas de tu siervo tu rostro, /nPorque estoy angustiado; apresúrate, óyeme.',
    '/nAcércate a mi alma, redímela; /nLíbrame a causa de mis enemigos.',
    ...
    '/nSea su convite delante de ellos por lazo, /nY lo que es para bien, por tropiezo.',
    '/nSean oscurecidos sus ojos para que no vean, /nY haz temblar continuamente sus lomos.',
    '/nDerrama sobre ellos tu ira, /nY el furor de tu enojo los alcance.',
    '/nSea su palacio asolado; /nEn sus tiendas no haya morador.',
    '/nPorque persiguieron al que tú heriste, /nY cuentan del dolor de los que tú llagaste.',
    '/nPon maldad sobre su maldad, /nY no entren en tu justicia.',
    '/nSean raídos del libro de los vivientes, /nY no sean escritos entre los justos.',
    '/nMas a mí, afligido y miserable, /nTu salvación, oh Dios, me ponga en alto.',
    '/nAlabaré yo el nombre de Dios con cántico, /nLo exaltaré con alabanza.',
    '/nY agradará a Jehová más que sacrificio de buey, /nO becerro que tiene cuernos y pezuñas;',
    '/nLo verán los oprimidos, y se gozarán. /nBuscad a Dios, y vivirá vuestro corazón,',
    '/nPorque Jehová oye a los menesterosos, /nY no menosprecia a sus prisioneros.',
    ...
    '/nLa descendencia de sus siervos la heredará, /nY los que aman su nombre habitarán en ella.'
  ],
  [
    ...
    '/nSean vueltos atrás, en pago de su afrenta hecha, /nLos que dicen: ¡Ah! ¡Ah!',
  ...
  [
    '/nEn ti, oh Jehová, me he refugiado; /nNo sea yo avergonzado jamás.',
    '/nSocórreme y líbrame en tu justicia; /nInclina tu oído y sálvame.',
    ...
    '/nPorque tú, oh Señor Jehová, eres mi esperanza, /nSeguridad mía desde mi juventud.',
    ...
    '/nComo prodigio he sido a muchos, /nY tú mi refugio fuerte.',
    '/nSea llena mi boca de tu alabanza, /nDe tu gloria todo el día.',
    '/nNo me deseches en el tiempo de la vejez; /nCuando mi fuerza se acabare, no me desampares.',
    '/nPorque mis enemigos hablan de mí, /nY los que acechan mi alma consultaron juntamente,',
    ...
    '/nMas yo esperaré siempre, /nY te alabaré más y más.',
    '/nMi boca publicará tu justicia /nY tus hechos de salvación todo el día, /nAunque no sé su número.',
    '/nVendré a los hechos poderosos de Jehová el Señor; /nHaré memoria de tu justicia, de la tuya sola.',
    '/nOh Dios, me enseñaste desde mi juventud, /nY hasta ahora he manifestado tus maravillas.',
    ...
    '/nY tu justicia, oh Dios, hasta lo excelso. /nTú has hecho grandes cosas; /nOh Dios, ¿quién como tú?',
    ...
    '/nAumentarás mi grandeza, /nY volverás a consolarme.',
  ...
  [
    '/nOh Dios, da tus juicios al rey, /nY tu justicia al hijo del rey.',
    '/nEl juzgará a tu pueblo con justicia, /nY a tus afligidos con juicio.',
    '/nLos montes llevarán paz al pueblo, /nY los collados justicia.',
    ...
    '/nLos reyes de Tarsis y de las costas traerán presentes; /nLos reyes de Sabá y de Seba ofrecerán dones.',
    '/nTodos los reyes se postrarán delante de él; /nTodas las naciones le servirán.',
    '/nPorque él librará al menesteroso que clamare, /nY al afligido que no tuviere quien le socorra.',
    '/nTendrá misericordia del pobre y del menesteroso, /nY salvará la vida de los pobres.',
    '/nDe engaño y de violencia redimirá sus almas, /nY la sangre de ellos será preciosa ante sus ojos.',
    ...
    '/nSerá su nombre para siempre, /nSe perpetuará su nombre mientras dure el sol. /nBenditas serán en él todas las naciones; /nLo llamarán bienaventurado.',
    '/nBendito Jehová Dios, el Dios de Israel, /nEl único que hace maravillas.',
    '/nBendito su nombre glorioso para siempre, /nY toda la tierra sea llena de su gloria. /nAmén y Amén.',
    '/nAquí terminan las oraciones de David, hijo de Isaí.'
  ],
  [
    ...
    '/nPorque tuve envidia de los arrogantes, /nViendo la prosperidad de los impíos.',
    '/nPorque no tienen congojas por su muerte, /nPues su vigor está entero.',
    '/nNo pasan trabajos como los otros mortales, /nNi son azotados como los demás hombres.',
    '/nPor tanto, la soberbia los corona; /nSe cubren de vestido de violencia.',
    ...
    '/nPor eso Dios hará volver a su pueblo aquí, /nY aguas en abundancia serán extraídas para ellos.',
    '/nY dicen: ¿Cómo sabe Dios? /n¿Y hay conocimiento en el Altísimo?',
    '/nHe aquí estos impíos, /nSin ser turbados del mundo, alcanzaron riquezas.',
    '/nVerdaderamente en vano he limpiado mi corazón, /nY lavado mis manos en inocencia;',
    '/nPues he sido azotado todo el día, /nY castigado todas las mañanas.',
    '/nSi dijera yo: Hablaré como ellos, /nHe aquí, a la generación de tus hijos engañaría.',
    '/nCuando pensé para saber esto, /nFue duro trabajo para mí,',
    '/nHasta que entrando en el santuario de Dios, /nComprendí el fin de ellos.',
    '/nCiertamente los has puesto en deslizaderos; /nEn asolamientos los harás caer.',
    '/n¡Cómo han sido asolados de repente! /nPerecieron, se consumieron de terrores.',
    '/nComo sueño del que despierta, /nAsí, Señor, cuando despertares, menospreciarás su apariencia.',
    '/nSe llenó de amargura mi alma, /nY en mi corazón sentía punzadas.',
    ...
    '/nMe has guiado según tu consejo, /nY después me recibirás en gloria.',
    ...
    '/nPorque he aquí, los que se alejan de ti perecerán; /nTú destruirás a todo aquel que de ti se aparta.',
  ...
  [
    ...
    '/nAcuérdate de tu congregación, la que adquiriste desde tiempos antiguos, /nLa que redimiste para hacerla la tribu de tu herencia; /nEste monte de Sion, donde has habitado.',
    '/nDirige tus pasos a los asolamientos eternos, /nA todo el mal que el enemigo ha hecho en el santuario.',
    '/nTus enemigos vociferan en medio de tus asambleas; /nHan puesto sus divisas por señales.',
    '/nSe parecen a los que levantan /nEl hacha en medio de tupido bosque.',
    '/nY ahora con hachas y martillos /nHan quebrado todas sus entalladuras.',
    '/nHan puesto a fuego tu santuario, /nHan profanado el tabernáculo de tu nombre, echándolo a tierra.',
    '/nDijeron en su corazón: Destruyámoslos de una vez; /nHan quemado todas las sinagogas de Dios en la tierra.',
    ...
    '/n¿Por qué retraes tu mano? /n¿Por qué escondes tu diestra en tu seno?',
    ...
    '/nAbriste la fuente y el río; /nSecaste ríos impetuosos.',
    '/nTuyo es el día, tuya también es la noche; /nTú estableciste la luna y el sol.',
    ...
    '/nMira al pacto, /nPorque los lugares tenebrosos de la tierra están llenos de habitaciones de violencia.',
    '/nNo vuelva avergonzado el abatido; /nEl afligido y el menesteroso alabarán tu nombre.',
    '/nLevántate, oh Dios, aboga tu causa; /nAcuérdate de cómo el insensato te injuria cada día.',
    '/nNo olvides las voces de tus enemigos; /nEl alboroto de los que se levantan contra ti sube continuamente.'
  ],
  [
    ...
    '/nSe arruinaban la tierra y sus moradores; /nYo sostengo sus columnas. Selah',
    ...
    '/nPorque ni de oriente ni de occidente, /nNi del desierto viene el enaltecimiento.',
    ...
    '/nPero yo siempre anunciaré /nY cantaré alabanzas al Dios de Jacob.',
    '/nQuebrantaré todo el poderío de los pecadores, /nPero el poder del justo será exaltado.'
  ],
  [
    '/nDios es conocido en Judá; /nEn Israel es grande su nombre.',
    '/nEn Salem está su tabernáculo, /nY su habitación en Sion.',
    '/nAllí quebró las saetas del arco, /nEl escudo, la espada y las armas de guerra. Selah',
    '/nGlorioso eres tú, poderoso más que los montes de caza.',
    '/nLos fuertes de corazón fueron despojados, durmieron su sueño; /nNo hizo uso de sus manos ninguno de los varones fuertes.',
    ...
    '/nCuando te levantaste, oh Dios, para juzgar, /nPara salvar a todos los mansos de la tierra. Selah',
    '/nCiertamente la ira del hombre te alabará; /nTú reprimirás el resto de las iras.',
    '/nPrometed, y pagad a Jehová vuestro Dios; /nTodos los que están alrededor de él, traigan ofrendas al Temible.',
    '/nCortará él el espíritu de los príncipes; /nTemible es a los reyes de la tierra.'
  ],
  [
    '/nCon mi voz clamé a Dios, /nA Dios clamé, y él me escuchará.',
    '/nAl Señor busqué en el día de mi angustia; /nAlzaba a él mis manos de noche, sin descanso; /nMi alma rehusaba consuelo.',
    '/nMe acordaba de Dios, y me conmovía; /nMe quejaba, y desmayaba mi espíritu. Selah',
    '/nNo me dejabas pegar los ojos; /nEstaba yo quebrantado, y no hablaba.',
    ...
    '/n¿Ha cesado para siempre su misericordia? /n¿Se ha acabado perpetuamente su promesa?',
    '/n¿Ha olvidado Dios el tener misericordia? /n¿Ha encerrado con ira sus piedades? Selah',
    ...
    '/nMeditaré en todas tus obras, /nY hablaré de tus hechos.',
    '/nOh Dios, santo es tu camino; /n¿Qué dios es grande como nuestro Dios?',
    '/nTú eres el Dios que hace maravillas; /nHiciste notorio en los pueblos tu poder.',
    '/nCon tu brazo redimiste a tu pueblo, /nA los hijos de Jacob y de José. Selah',
    '/nTe vieron las aguas, oh Dios; /nLas aguas te vieron, y temieron; /nLos abismos también se estremecieron.',
    '/nLas nubes echaron inundaciones de aguas; /nTronaron los cielos, /nY discurrieron tus rayos.',
    ...
    '/nCondujiste a tu pueblo como ovejas /nPor mano de Moisés y de Aarón.'
  ],
  [
    '/nEscucha, pueblo mío, mi ley; /nInclinad vuestro oído a las palabras de mi boca.',
    ...
    '/nEl estableció testimonio en Jacob, /nY puso ley en Israel, /nLa cual mandó a nuestros padres /nQue la notificasen a sus hijos;',
    ...
    '/nDelante de sus padres hizo maravillas /nEn la tierra de Egipto, en el campo de Zoán.',
    '/nDividió el mar y los hizo pasar; /nDetuvo las aguas como en un montón.',
    ...
    '/nPues sacó de la peña corrientes, /nE hizo descender aguas como ríos.',
    '/nPero aún volvieron a pecar contra él, /nRebelándose contra el Altísimo en el desierto;',
    '/nPues tentaron a Dios en su corazón, /nPidiendo comida a su gusto.',
    '/nY hablaron contra Dios, /nDiciendo: ¿Podrá poner mesa en el desierto?',
    ...
    '/nSin embargo, mandó a las nubes de arriba, /nY abrió las puertas de los cielos,',
    '/nE hizo llover sobre ellos maná para que comiesen, /nY les dio trigo de los cielos.',
    '/nPan de nobles comió el hombre; /nLes envió comida hasta saciarles.',
    '/nMovió el solano en el cielo, /nY trajo con su poder el viento sur,',
    '/nE hizo llover sobre ellos carne como polvo, /nComo arena del mar, aves que vuelan.',
    '/nLas hizo caer en medio del campamento, /nAlrededor de sus tiendas.',
    '/nComieron, y se saciaron; /nLes cumplió, pues, su deseo.',
    '/nNo habían quitado de sí su anhelo, /nAún estaba la comida en su boca,',
    '/nCuando vino sobre ellos el furor de Dios, /nE hizo morir a los más robustos de ellos, /nY derribó a los escogidos de Israel.',
    '/nCon todo esto, pecaron aún, /nY no dieron crédito a sus maravillas.',
    '/nPor tanto, consumió sus días en vanidad, /nY sus años en tribulación.',
    '/nSi los hacía morir, entonces buscaban a Dios; /nEntonces se volvían solícitos en busca suya,',
    '/nY se acordaban de que Dios era su refugio, /nY el Dios Altísimo su redentor.',
    '/nPero le lisonjeaban con su boca, /nY con su lengua le mentían;',
    '/nPues sus corazones no eran rectos con él, /nNi estuvieron firmes en su pacto.',
    ...
    '/n¡Cuántas veces se rebelaron contra él en el desierto, /nLo enojaron en el yermo!',
    '/nY volvían, y tentaban a Dios, /nY provocaban al Santo de Israel.',
    '/nNo se acordaron de su mano, /nDel día que los redimió de la angustia;',
    '/nCuando puso en Egipto sus señales, /nY sus maravillas en el campo de Zoán;',
    '/nY volvió sus ríos en sangre, /nY sus corrientes, para que no bebiesen.',
    '/nEnvió entre ellos enjambres de moscas que los devoraban, /nY ranas que los destruían.',
    '/nDio también a la oruga sus frutos, /nY sus labores a la langosta.',
    '/nSus viñas destruyó con granizo, /nY sus higuerales con escarcha;',
    '/nEntregó al pedrisco sus bestias, /nY sus ganados a los rayos.',
    '/nEnvió sobre ellos el ardor de su ira; /nEnojo, indignación y angustia, /nUn ejército de ángeles destructores.',
    '/nDispuso camino a su furor; /nNo eximió la vida de ellos de la muerte, /nSino que entregó su vida a la mortandad.',
    '/nHizo morir a todo primogénito en Egipto, /nLas primicias de su fuerza en las tiendas de Cam.',
    '/nHizo salir a su pueblo como ovejas, /nY los llevó por el desierto como un rebaño.',
    '/nLos guió con seguridad, de modo que no tuvieran temor; /nY el mar cubrió a sus enemigos.',
    '/nLos trajo después a las fronteras de su tierra santa, /nA este monte que ganó su mano derecha.',
    ...
    '/nSino que se volvieron y se rebelaron como sus padres; /nSe volvieron como arco engañoso.',
    '/nLe enojaron con sus lugares altos, /nY le provocaron a celo con sus imágenes de talla.',
    '/nLo oyó Dios y se enojó, /nY en gran manera aborreció a Israel.',
    '/nDejó, por tanto, el tabernáculo de Silo, /nLa tienda en que habitó entre los hombres,',
    '/nY entregó a cautiverio su poderío, /nY su gloria en mano del enemigo.',
    ...
    '/nSus sacerdotes cayeron a espada, /nY sus viudas no hicieron lamentación.',
    ...
    '/nDesechó la tienda de José, /nY no escogió la tribu de Efraín,',
    '/nSino que escogió la tribu de Judá, /nEl monte de Sion, al cual amó.',
    '/nEdificó su santuario a manera de eminencia, /nComo la tierra que cimentó para siempre.',
    '/nEligió a David su siervo, /nY lo tomó de las majadas de las ovejas;',
    '/nDe tras las paridas lo trajo, /nPara que apacentase a Jacob su pueblo, /nY a Israel su heredad.',
    '/nY los apacentó conforme a la integridad de su corazón, /nLos pastoreó con la pericia de sus manos.'
  ],
  [
    ...
    '/nDerramaron su sangre como agua en los alrededores de Jerusalén, /nY no hubo quien los enterrase.',
    ...
    '/nPorque han consumido a Jacob, /nY su morada han asolado.',
    ...
    '/nY nosotros, pueblo tuyo, y ovejas de tu prado, /nTe alabaremos para siempre; /nDe generación en generación cantaremos tus alabanzas.'
  ],
  [
    '/nOh Pastor de Israel, escucha; /nTú que pastoreas como a ovejas a José, /nQue estás entre querubines, resplandece.',
    '/nDespierta tu poder delante de Efraín, de Benjamín y de Manasés, /nY ven a salvarnos.',
    '/nOh Dios, restáuranos; /nHaz resplandecer tu rostro, y seremos salvos.',
    '/nJehová, Dios de los ejércitos, /n¿Hasta cuándo mostrarás tu indignación contra la oración de tu pueblo?',
    '/nLes diste a comer pan de lágrimas, /nY a beber lágrimas en gran abundancia.',
    '/nNos pusiste por escarnio a nuestros vecinos, /nY nuestros enemigos se burlan entre sí.',
    '/nOh Dios de los ejércitos, restáuranos; /nHaz resplandecer tu rostro, y seremos salvos.',
    '/nHiciste venir una vid de Egipto; /nEchaste las naciones, y la plantaste.',
    '/nLimpiaste sitio delante de ella, /nE hiciste arraigar sus raíces, y llenó la tierra.',
    '/nLos montes fueron cubiertos de su sombra, /nY con sus sarmientos los cedros de Dios.',
    '/nExtendió sus vástagos hasta el mar, /nY hasta el río sus renuevos.',
    '/n¿Por qué aportillaste sus vallados, /nY la vendimian todos los que pasan por el camino?',
  ...
  [
    ...
    '/nEntonad canción, y tañed el pandero, /nEl arpa deliciosa y el salterio.',
    '/nTocad la trompeta en la nueva luna, /nEn el día señalado, en el día de nuestra fiesta solemne.',
    '/nPorque estatuto es de Israel, /nOrdenanza del Dios de Jacob.',
    '/nLo constituyó como testimonio en José /nCuando salió por la tierra de Egipto. /nOí lenguaje que no entendía;',
    ...
    '/n¡Oh, si me hubiera oído mi pueblo, /nSi en mis caminos hubiera andado Israel!',
    ...
    '/nLes sustentaría Dios con lo mejor del trigo, /nY con miel de la peña les saciaría.'
  ],
  [
    '/nDios está en la reunión de los dioses; /nEn medio de los dioses juzga.',
    ...
    '/nPero como hombres moriréis, /nY como cualquiera de los príncipes caeréis.',
  ...
  [
    ...
    '/nLas tiendas de los edomitas y de los ismaelitas, /nMoab y los agarenos;',
    '/nGebal, Amón y Amalec, /nLos filisteos y los habitantes de Tiro.',
    '/nTambién el asirio se ha juntado con ellos; /nSirven de brazo a los hijos de Lot. Selah',
    '/nHazles como a Madián, /nComo a Sísara, como a Jabín en el arroyo de Cisón;',
    '/nQue perecieron en Endor, /nFueron hechos como estiércol para la tierra.',
    '/nPon a sus capitanes como a Oreb y a Zeeb; /nComo a Zeba y a Zalmuna a todos sus príncipes,',
    ...
    '/nComo fuego que quema el monte, /nComo llama que abrasa el bosque.',
    '/nPersíguelos así con tu tempestad, /nY atérralos con tu torbellino.',
    '/nLlena sus rostros de vergüenza, /nY busquen tu nombre, oh Jehová.',
    '/nSean afrentados y turbados para siempre; /nSean deshonrados, y perezcan.',
  ...
  [
    ...
    '/nAnhela mi alma y aun ardientemente desea los atrios de Jehová; /nMi corazón y mi carne cantan al Dios vivo.',
    ...
    '/nJehová Dios de los ejércitos, oye mi oración; /nEscucha, oh Dios de Jacob. Selah',
    '/nMira, oh Dios, escudo nuestro, /nY pon los ojos en el rostro de tu ungido.',
    ...
    '/nJehová de los ejércitos, /nDichoso el hombre que en ti confía.'
  ],
  [
    '/nFuiste propicio a tu tierra, oh Jehová; /nVolviste la cautividad de Jacob.',
    '/nPerdonaste la iniquidad de tu pueblo; /nTodos los pecados de ellos cubriste. Selah',
    ...
    '/n¿Estarás enojado contra nosotros para siempre? /n¿Extenderás tu ira de generación en generación?',
    ...
    '/nEscucharé lo que hablará Jehová Dios; /nPorque hablará paz a su pueblo y a sus santos, /nPara que no se vuelvan a la locura.',
    '/nCiertamente cercana está su salvación a los que le temen, /nPara que habite la gloria en nuestra tierra.',
    ...
    '/nJehová dará también el bien, /nY nuestra tierra dará su fruto.',
    '/nLa justicia irá delante de él, /nY sus pasos nos pondrá por camino.'
  ],
  [
    '/nInclina, oh Jehová, tu oído, y escúchame, /nPorque estoy afligido y menesteroso.',
    '/nGuarda mi alma, porque soy piadoso; /nSalva tú, oh Dios mío, a tu siervo que en ti confía.',
    '/nTen misericordia de mí, oh Jehová; /nPorque a ti clamo todo el día.',
    '/nAlegra el alma de tu siervo, /nPorque a ti, oh Señor, levanto mi alma.',
    '/nPorque tú, Señor, eres bueno y perdonador, /nY grande en misericordia para con todos los que te invocan.',
    ...
    '/nTodas las naciones que hiciste vendrán y adorarán delante de ti, Señor, /nY glorificarán tu nombre.',
    '/nPorque tú eres grande, y hacedor de maravillas; /nSólo tú eres Dios.',
    ...
    '/nPorque tu misericordia es grande para conmigo, /nY has librado mi alma de las profundidades del Seol.',
  ...
  [
    ...
    '/nPorque mi alma está hastiada de males, /nY mi vida cercana al Seol.',
  ...
  [
    ...
    '/nPorque dije: Para siempre será edificada misericordia; /nEn los cielos mismos afirmarás tu verdad.',
    ...
    '/nCelebrarán los cielos tus maravillas, oh Jehová, /nTu verdad también en la congregación de los santos.',
    '/nPorque ¿quién en los cielos se igualará a Jehová? /n¿Quién será semejante a Jehová entre los hijos de los potentados?',
    ...
    '/nTuyos son los cielos, tuya también la tierra; /nEl mundo y su plenitud, tú lo fundaste.',
    '/nEl norte y el sur, tú los creaste; /nEl Tabor y el Hermón cantarán en tu nombre.',
    '/nTuyo es el brazo potente; /nFuerte es tu mano, exaltada tu diestra.',
    '/nJusticia y juicio son el cimiento de tu trono; /nMisericordia y verdad van delante de tu rostro.',
    '/nBienaventurado el pueblo que sabe aclamarte; /nAndará, oh Jehová, a la luz de tu rostro.',
    '/nEn tu nombre se alegrará todo el día, /nY en tu justicia será enaltecido.',
    '/nPorque tú eres la gloria de su potencia, /nY por tu buena voluntad acrecentarás nuestro poder.',
    '/nPorque Jehová es nuestro escudo, /nY nuestro rey es el Santo de Israel.',
    ...
    '/nMi mano estará siempre con él, /nMi brazo también lo fortalecerá.',
    '/nNo lo sorprenderá el enemigo, /nNi hijo de iniquidad lo quebrantará;',
    '/nSino que quebrantaré delante de él a sus enemigos, /nY heriré a los que le aborrecen.',
    '/nMi verdad y mi misericordia estarán con él, /nY en mi nombre será exaltado su poder.',
    '/nAsimismo pondré su mano sobre el mar, /nY sobre los ríos su diestra.',
    '/nEl me clamará: Mi padre eres tú, /nMi Dios, y la roca de mi salvación.',
    ...
    '/nPondré su descendencia para siempre, /nY su trono como los días de los cielos.',
    '/nSi dejaren sus hijos mi ley, /nY no anduvieren en mis juicios,',
    '/nSi profanaren mis estatutos, /nY no guardaren mis mandamientos,',
    ...
    '/nNo olvidaré mi pacto, /nNi mudaré lo que ha salido de mis labios.',
    ...
    '/nRompiste el pacto de tu siervo; /nHas profanado su corona hasta la tierra.',
    '/nAportillaste todos sus vallados; /nHas destruido sus fortalezas.',
    ...
    '/nHiciste cesar su gloria, /nY echaste su trono por tierra.',
    '/nHas acortado los días de su juventud; /nLe has cubierto de afrenta. Selah',
    '/n¿Hasta cuándo, oh Jehová? ¿Te esconderás para siempre? /n¿Arderá tu ira como el fuego?',
    '/nRecuerda cuán breve es mi tiempo; /n¿Por qué habrás creado en vano a todo hijo de hombre?',
    ...
    '/nPorque tus enemigos, oh Jehová, han deshonrado, /nPorque tus enemigos han deshonrado los pasos de tu ungido.',
    '/nBendito sea Jehová para siempre. /nAmén, y Amén.'
  ],
  [
    '/nSeñor, tú nos has sido refugio /nDe generación en generación.',
    ...
    '/nPorque mil años delante de tus ojos /nSon como el día de ayer, que pasó, /nY como una de las vigilias de la noche.',
    '/nLos arrebatas como con torrente de aguas; son como sueño, /nComo la hierba que crece en la mañana.',
    ...
    '/nPusiste nuestras maldades delante de ti, /nNuestros yerros a la luz de tu rostro.',
    ...
    '/nEnséñanos de tal modo a contar nuestros días, /nQue traigamos al corazón sabiduría.',
    '/nVuélvete, oh Jehová; ¿hasta cuándo? /nY aplácate para con tus siervos.',
    '/nDe mañana sácianos de tu misericordia, /nY cantaremos y nos alegraremos todos nuestros días.',
    '/nAlégranos conforme a los días que nos afligiste, /nY los años en que vimos el mal.',
    '/nAparezca en tus siervos tu obra, /nY tu gloria sobre sus hijos.',
  ...
  [
    '/nEl que habita al abrigo del Altísimo /nMorará bajo la sombra del Omnipotente.',
    '/nDiré yo a Jehová: Esperanza mía, y castillo mío; /nMi Dios, en quien confiaré.',
    '/nEl te librará del lazo del cazador, /nDe la peste destructora.',
    '/nCon sus plumas te cubrirá, /nY debajo de sus alas estarás seguro; /nEscudo y adarga es su verdad.',
    ...
    '/nCaerán a tu lado mil, /nY diez mil a tu diestra; /nMas a ti no llegará.',
    ...
    '/nNo te sobrevendrá mal, /nNi plaga tocará tu morada.',
    ...
    '/nSobre el león y el áspid pisarás; /nHollarás al cachorro del león y al dragón.',
    ...
    '/nLo saciaré de larga vida, /nY le mostraré mi salvación.'
  ],
  [
    '/nBueno es alabarte, oh Jehová, /nY cantar salmos a tu nombre, oh Altísimo;',
    '/nAnunciar por la mañana tu misericordia, /nY tu fidelidad cada noche,',
    ...
    '/n¡Cuán grandes son tus obras, oh Jehová! /nMuy profundos son tus pensamientos.',
    '/nEl hombre necio no sabe, /nY el insensato no entiende esto.',
    ...
    '/nPorque he aquí tus enemigos, oh Jehová, /nPorque he aquí, perecerán tus enemigos; /nSerán esparcidos todos los que hacen maldad.',
    '/nPero tú aumentarás mis fuerzas como las del búfalo; /nSeré ungido con aceite fresco.',
    '/nY mirarán mis ojos sobre mis enemigos; /nOirán mis oídos de los que se levantaron contra mí, de los malignos.',
    '/nEl justo florecerá como la palmera; /nCrecerá como cedro en el Líbano.',
    '/nPlantados en la casa de Jehová, /nEn los atrios de nuestro Dios florecerán.',
    '/nAun en la vejez fructificarán; /nEstarán vigorosos y verdes,',
    '/nPara anunciar que Jehová mi fortaleza es recto, /nY que en él no hay injusticia.'
  ],
  [
    '/nJehová reina; se vistió de magnificencia; /nJehová se vistió, se ciñó de poder. /nAfirmó también el mundo, y no se moverá.',
    '/nFirme es tu trono desde entonces; /nTú eres eternamente.',
    '/nAlzaron los ríos, oh Jehová, /nLos ríos alzaron su sonido; /nAlzaron los ríos sus ondas.',
    '/nJehová en las alturas es más poderoso /nQue el estruendo de las muchas aguas, /nMás que las recias ondas del mar.',
    '/nTus testimonios son muy firmes; /nLa santidad conviene a tu casa, /nOh Jehová, por los siglos y para siempre.'
  ],
  [
    '/nJehová, Dios de las venganzas, /nDios de las venganzas, muéstrate.',
    '/nEngrandécete, oh Juez de la tierra; /nDa el pago a los soberbios.',
    '/n¿Hasta cuándo los impíos, /nHasta cuándo, oh Jehová, se gozarán los impíos?',
    ...
    '/nY dijeron: No verá JAH, /nNi entenderá el Dios de Jacob.',
    '/nEntended, necios del pueblo; /nY vosotros, fatuos, ¿cuándo seréis sabios?',
    '/nEl que hizo el oído, ¿no oirá? /nEl que formó el ojo, ¿no verá?',
    '/nEl que castiga a las naciones, ¿no reprenderá? /n¿No sabrá el que enseña al hombre la ciencia?',
    '/nJehová conoce los pensamientos de los hombres, /nQue son vanidad.',
    ...
    '/n¿Quién se levantará por mí contra los malignos? /n¿Quién estará por mí contra los que hacen iniquidad?',
    '/nSi no me ayudara Jehová, /nPronto moraría mi alma en el silencio.',
    '/nCuando yo decía: Mi pie resbala, /nTu misericordia, oh Jehová, me sustentaba.',
    '/nEn la multitud de mis pensamientos dentro de mí, /nTus consolaciones alegraban mi alma.',
    '/n¿Se juntará contigo el trono de iniquidades /nQue hace agravio bajo forma de ley?',
    '/nSe juntan contra la vida del justo, /nY condenan la sangre inocente.',
    '/nMas Jehová me ha sido por refugio, /nY mi Dios por roca de mi confianza.',
    '/nY él hará volver sobre ellos su iniquidad, /nY los destruirá en su propia maldad; /nLos destruirá Jehová nuestro Dios.'
  ],
  [
    '/nVenid, aclamemos alegremente a Jehová; /nCantemos con júbilo a la roca de nuestra salvación.',
    '/nLleguemos ante su presencia con alabanza; /nAclamémosle con cánticos.',
    '/nPorque Jehová es Dios grande, /nY Rey grande sobre todos los dioses.',
    '/nPorque en su mano están las profundidades de la tierra, /nY las alturas de los montes son suyas.',
    '/nSuyo también el mar, pues él lo hizo; /nY sus manos formaron la tierra seca.',
    ...
    '/nCuarenta años estuve disgustado con la nación, /nY dije: Pueblo es que divaga de corazón, /nY no han conocido mis caminos.',
    '/nPor tanto, juré en mi furor /nQue no entrarían en mi reposo.'
  ],
  [
    '/nCantad a Jehová cántico nuevo; /nCantad a Jehová, toda la tierra.',
    '/nCantad a Jehová, bendecid su nombre; /nAnunciad de día en día su salvación.',
    '/nProclamad entre las naciones su gloria, /nEn todos los pueblos sus maravillas.',
    ...
    '/nAlabanza y magnificencia delante de él; /nPoder y gloria en su santuario.',
    '/nTributad a Jehová, oh familias de los pueblos, /nDad a Jehová la gloria y el poder.',
    '/nDad a Jehová la honra debida a su nombre; /nTraed ofrendas, y venid a sus atrios.',
    '/nAdorad a Jehová en la hermosura de la santidad; /nTemed delante de él, toda la tierra.',
    ...
    '/nRegocíjese el campo, y todo lo que en él está; /nEntonces todos los árboles del bosque rebosarán de contento,',
  ...
  [
    '/nJehová reina; regocíjese la tierra, /nAlégrense las muchas costas.',
    '/nNubes y oscuridad alrededor de él; /nJusticia y juicio son el cimiento de su trono.',
    '/nFuego irá delante de él, /nY abrasará a sus enemigos alrededor.',
    '/nSus relámpagos alumbraron el mundo; /nLa tierra vio y se estremeció.',
    '/nLos montes se derritieron como cera delante de Jehová, /nDelante del Señor de toda la tierra.',
    '/nLos cielos anunciaron su justicia, /nY todos los pueblos vieron su gloria.',
    ...
    '/nLuz está sembrada para el justo, /nY alegría para los rectos de corazón.',
  ...
  [
    ...
    '/nJehová ha hecho notoria su salvación; /nA vista de las naciones ha descubierto su justicia.',
    '/nSe ha acordado de su misericordia y de su verdad para con la casa de Israel; /nTodos los términos de la tierra han visto la salvación de nuestro Dios.',
    ...
    '/nLos ríos batan las manos, /nLos montes todos hagan regocijo',
  ...
  [
    ...
    '/nJehová en Sion es grande, /nY exaltado sobre todos los pueblos.',
    '/nAlaben tu nombre grande y temible; /nEl es santo.',
    '/nY la gloria del rey ama el juicio; /nTú confirmas la rectitud; /nTú has hecho en Jacob juicio y justicia.',
    '/nExaltad a Jehová nuestro Dios, /nY postraos ante el estrado de sus pies; /nEl es santo.',
    '/nMoisés y Aarón entre sus sacerdotes, /nY Samuel entre los que invocaron su nombre; /nInvocaban a Jehová, y él les respondía.',
    '/nEn columna de nube hablaba con ellos; /nGuardaban sus testimonios, y el estatuto que les había dado.',
    '/nJehová Dios nuestro, tú les respondías; /nLes fuiste un Dios perdonador, /nY retribuidor de sus obras.',
    '/nExaltad a Jehová nuestro Dios, /nY postraos ante su santo monte, /nPorque Jehová nuestro Dios es santo.'
  ],
  [
    '/nCantad alegres a Dios, habitantes de toda la tierra.',
    '/nServid a Jehová con alegría; /nVenid ante su presencia con regocijo.',
    '/nReconoced que Jehová es Dios; /nEl nos hizo, y no nosotros a nosotros mismos; /nPueblo suyo somos, y ovejas de su prado.',
    '/nEntrad por sus puertas con acción de gracias, /nPor sus atrios con alabanza; /nAlabadle, bendecid su nombre.',
    '/nPorque Jehová es bueno; para siempre es su misericordia, /nY su verdad por todas las generaciones.'
  ],
  [
    '/nMisericordia y juicio cantaré; /nA ti cantaré yo, oh Jehová.',
    ...
    '/nCorazón perverso se apartará de mí; /nNo conoceré al malvado.',
  ...
  [
    ...
    '/nPorque mis días se han consumido como humo, /nY mis huesos cual tizón están quemados.',
    '/nMi corazón está herido, y seco como la hierba, /nPor lo cual me olvido de comer mi pan.',
    '/nPor la voz de mi gemido /nMis huesos se han pegado a mi carne.',
    ...
    '/nPor lo cual yo como ceniza a manera de pan, /nY mi bebida mezclo con lágrimas,',
    '/nA causa de tu enojo y de tu ira; /nPues me alzaste, y me has arrojado.',
    '/nMis días son como sombra que se va, /nY me he secado como la hierba.',
    '/nMas tú, Jehová, permanecerás para siempre, /nY tu memoria de generación en generación.',
    ...
    '/nEntonces las naciones temerán el nombre de Jehová, /nY todos los reyes de la tierra tu gloria;',
    '/nPor cuanto Jehová habrá edificado a Sion, /nY en su gloria será visto;',
    '/nHabrá considerado la oración de los desvalidos, /nY no habrá desechado el ruego de ellos.',
    '/nSe escribirá esto para la generación venidera; /nY el pueblo que está por nacer alabará a JAH,',
    '/nPorque miró desde lo alto de su santuario; /nJehová miró desde los cielos a la tierra,',
    '/nPara oír el gemido de los presos, /nPara soltar a los sentenciados a muerte;',
    '/nPara que publique en Sion el nombre de Jehová, /nY su alabanza en Jerusalén,',
    '/nCuando los pueblos y los reinos se congreguen /nEn uno para servir a Jehová.',
    ...
    '/nEllos perecerán, mas tú permanecerás; /nY todos ellos como una vestidura se envejecerán; /nComo un vestido los mudarás, y serán mudados;',
    '/nPero tú eres el mismo, /nY tus años no se acabarán.',
    '/nLos hijos de tus siervos habitarán seguros, /nY su descendencia será establecida delante de ti.'
  ],
  [
    '/nBendice, alma mía, a Jehová, /nY bendiga todo mi ser su santo nombre.',
    '/nBendice, alma mía, a Jehová, /nY no olvides ninguno de sus beneficios.',
    '/nEl es quien perdona todas tus iniquidades, /nEl que sana todas tus dolencias;',
    '/nEl que rescata del hoyo tu vida, /nEl que te corona de favores y misericordias;',
    ...
    '/nSus caminos notificó a Moisés, /nY a los hijos de Israel sus obras.',
    '/nMisericordioso y clemente es Jehová; /nLento para la ira, y grande en misericordia.',
    '/nNo contenderá para siempre, /nNi para siempre guardará el enojo.',
    '/nNo ha hecho con nosotros conforme a nuestras iniquidades, /nNi nos ha pagado conforme a nuestros pecados.',
    '/nPorque como la altura de los cielos sobre la tierra, /nEngrandeció su misericordia sobre los que le temen.',
    '/nCuanto está lejos el oriente del occidente, /nHizo alejar de nosotros nuestras rebeliones.',
    '/nComo el padre se compadece de los hijos, /nSe compadece Jehová de los que le temen.',
    '/nPorque él conoce nuestra condición; /nSe acuerda de que somos polvo.',
    '/nEl hombre, como la hierba son sus días; /nFlorece como la flor del campo,',
    '/nQue pasó el viento por ella, y pereció, /nY su lugar no la conocerá más.',
    ...
    '/nSobre los que guardan su pacto, /nY los que se acuerdan de sus mandamientos para ponerlos por obra.',
    '/nJehová estableció en los cielos su trono, /nY su reino domina sobre todos.',
    ...
    '/nBendecid a Jehová, vosotros todos sus ejércitos, /nMinistros suyos, que hacéis su voluntad.',
  ...
  [
    ...
    '/nQue establece sus aposentos entre las aguas, /nEl que pone las nubes por su carroza, /nEl que anda sobre las alas del viento;',
    '/nEl que hace a los vientos sus mensajeros, /nY a las flamas de fuego sus ministros.',
    '/nEl fundó la tierra sobre sus cimientos; /nNo será jamás removida.',
    ...
    '/nSubieron los montes, descendieron los valles, /nAl lugar que tú les fundaste.',
    '/nLes pusiste término, el cual no traspasarán, /nNi volverán a cubrir la tierra.',
    '/nTú eres el que envía las fuentes por los arroyos; /nVan entre los montes;',
    '/nDan de beber a todas las bestias del campo; /nMitigan su sed los asnos monteses.',
    '/nA sus orillas habitan las aves de los cielos; /nCantan entre las ramas.',
    '/nEl riega los montes desde sus aposentos; /nDel fruto de sus obras se sacia la tierra.',
    '/nEl hace producir el heno para las bestias, /nY la hierba para el servicio del hombre, /nSacando el pan de la tierra,',
    ...
    '/nHizo la luna para los tiempos; /nEl sol conoce su ocaso.',
    '/nPones las tinieblas, y es la noche; /nEn ella corretean todas las bestias de la selva.',
    '/nLos leoncillos rugen tras la presa, /nY para buscar de Dios su comida.',
    '/nSale el sol, se recogen, /nY se echan en sus cuevas.',
    '/nSale el hombre a su labor, /nY a su labranza hasta la tarde.',
    '/n¡Cuán innumerables son tus obras, oh Jehová! /nHiciste todas ellas con sabiduría; /nLa tierra está llena de tus beneficios.',
    '/nHe allí el grande y anchuroso mar, /nEn donde se mueven seres innumerables, /nSeres pequeños y grandes.',
    '/nAllí andan las naves; /nAllí este leviatán que hiciste para que jugase en él.',
    '/nTodos ellos esperan en ti, /nPara que les des su comida a su tiempo.',
    '/nLes das, recogen; /nAbres tu mano, se sacian de bien.',
    '/nEscondes tu rostro, se turban; /nLes quitas el hálito, dejan de ser, /nY vuelven al polvo.',
    ...
    '/nSean consumidos de la tierra los pecadores, /nY los impíos dejen de ser. /nBendice, alma mía, a Jehová. /nAleluya.'
  ],
  [
    '/nAlabad a Jehová, invocad su nombre; /nDad a conocer sus obras en los pueblos.',
    '/nCantadle, cantadle salmos; /nHablad de todas sus maravillas.',
    '/nGloriaos en su santo nombre; /nAlégrese el corazón de los que buscan a Jehová.',
    '/nBuscad a Jehová y su poder; /nBuscad siempre su rostro.',
    '/nAcordaos de las maravillas que él ha hecho, /nDe sus prodigios y de los juicios de su boca,',
    '/nOh vosotros, descendencia de Abraham su siervo, /nHijos de Jacob, sus escogidos.',
    '/nEl es Jehová nuestro Dios; /nEn toda la tierra están sus juicios.',
    '/nSe acordó para siempre de su pacto; /nDe la palabra que mandó para mil generaciones,',
    '/nLa cual concertó con Abraham, /nY de su juramento a Isaac.',
    '/nLa estableció a Jacob por decreto, /nA Israel por pacto sempiterno,',
    '/nDiciendo: A ti te daré la tierra de Canaán /nComo porción de vuestra heredad.',
    '/nCuando ellos eran pocos en número, /nY forasteros en ella,',
    '/nY andaban de nación en nación, /nDe un reino a otro pueblo,',
    '/nNo consintió que nadie los agraviase, /nY por causa de ellos castigó a los reyes.',
    '/nNo toquéis, dijo, a mis ungidos, /nNi hagáis mal a mis profetas.',
    '/nTrajo hambre sobre la tierra, /nY quebrantó todo sustento de pan.',
    '/nEnvió un varón delante de ellos; /nA José, que fue vendido por siervo.',
    '/nAfligieron sus pies con grillos; /nEn cárcel fue puesta su persona.',
    '/nHasta la hora que se cumplió su palabra, /nEl dicho de Jehová le probó.',
    '/nEnvió el rey, y le soltó; /nEl señor de los pueblos, y le dejó ir libre.',
    '/nLo puso por señor de su casa, /nY por gobernador de todas sus posesiones,',
    '/nPara que reprimiera a sus grandes como él quisiese, /nY a sus ancianos enseñara sabiduría.',
    '/nDespués entró Israel en Egipto, /nY Jacob moró en la tierra de Cam.',
    '/nY multiplicó su pueblo en gran manera, /nY lo hizo más fuerte que sus enemigos.',
    '/nCambió el corazón de ellos para que aborreciesen a su pueblo, /nPara que contra sus siervos pensasen mal.',
    '/nEnvió a su siervo Moisés, /nY a Aarón, al cual escogió.',
    '/nPuso en ellos las palabras de sus señales, /nY sus prodigios en la tierra de Cam.',
    '/nEnvió tinieblas que lo oscurecieron todo; /nNo fueron rebeldes a su palabra.',
    '/nVolvió sus aguas en sangre, /nY mató sus peces.',
    '/nSu tierra produjo ranas /nHasta en las cámaras de sus reyes.',
    '/nHabló, y vinieron enjambres de moscas, /nY piojos en todos sus términos.',
    '/nLes dio granizo por lluvia, /nY llamas de fuego en su tierra.',
    '/nDestrozó sus viñas y sus higueras, /nY quebró los árboles de su territorio.',
    '/nHabló, y vinieron langostas, /nY pulgón sin número;',
    '/nY comieron toda la hierba de su país, /nY devoraron el fruto de su tierra.',
    '/nHirió de muerte a todos los primogénitos en su tierra, /nLas primicias de toda su fuerza.',
    '/nLos sacó con plata y oro; /nY no hubo en sus tribus enfermo.',
    '/nEgipto se alegró de que salieran, /nPorque su terror había caído sobre ellos.',
    '/nExtendió una nube por cubierta, /nY fuego para alumbrar la noche.',
    '/nPidieron, e hizo venir codornices; /nY los sació de pan del cielo.',
    '/nAbrió la peña, y fluyeron aguas; /nCorrieron por los sequedales como un río.',
    '/nPorque se acordó de su santa palabra /nDada a Abraham su siervo.',
    '/nSacó a su pueblo con gozo; /nCon júbilo a sus escogidos.',
    '/nLes dio las tierras de las naciones, /nY las labores de los pueblos heredaron;',
    '/nPara que guardasen sus estatutos, /nY cumpliesen sus leyes. /nAleluya.'
  ],
  [
    '/nAleluya. /nAlabad a Jehová, porque él es bueno; /nPorque para siempre es su misericordia.',
    '/n¿Quién expresará las poderosas obras de Jehová? /n¿Quién contará sus alabanzas?',
    ...
    '/nPecamos nosotros, como nuestros padres; /nHicimos iniquidad, hicimos impiedad.',
    ...
    '/nPero él los salvó por amor de su nombre, /nPara hacer notorio su poder.',
    '/nReprendió al Mar Rojo y lo secó, /nY les hizo ir por el abismo como por un desierto.',
    ...
    '/nEntonces creyeron a sus palabras /nY cantaron su alabanza.',
    '/nBien pronto olvidaron sus obras; /nNo esperaron su consejo.',
    '/nSe entregaron a un deseo desordenado en el desierto; /nY tentaron a Dios en la soledad.',
    '/nY él les dio lo que pidieron; /nMas envió mortandad sobre ellos.',
    '/nTuvieron envidia de Moisés en el campamento, /nY contra Aarón, el santo de Jehová.',
    '/nEntonces se abrió la tierra y tragó a Datán, /nY cubrió la compañía de Abiram.',
    '/nY se encendió fuego en su junta; /nLa llama quemó a los impíos.',
    '/nHicieron becerro en Horeb, /nSe postraron ante una imagen de fundición.',
    '/nAsí cambiaron su gloria /nPor la imagen de un buey que come hierba.',
    '/nOlvidaron al Dios de su salvación, /nQue había hecho grandezas en Egipto,',
    '/nMaravillas en la tierra de Cam, /nCosas formidables sobre el Mar Rojo.',
    ...
    '/nPero aborrecieron la tierra deseable; /nNo creyeron a su palabra,',
    '/nAntes murmuraron en sus tiendas, /nY no oyeron la voz de Jehová.',
    '/nPor tanto, alzó su mano contra ellos /nPara abatirlos en el desierto,',
    ...
    '/nEntonces se levantó Finees e hizo juicio, /nY se detuvo la plaga;',
    '/nY le fue contado por justicia /nDe generación en generación para siempre.',
    ...
    '/nNo destruyeron a los pueblos /nQue Jehová les dijo;',
    '/nAntes se mezclaron con las naciones, /nY aprendieron sus obras,',
    '/nY sirvieron a sus ídolos, /nLos cuales fueron causa de su ruina.',
    '/nSacrificaron sus hijos y sus hijas a los demonios,',
    '/nY derramaron la sangre inocente, la sangre de sus hijos y de sus hijas, /nQue ofrecieron en sacrificio a los ídolos de Canaán, /nY la tierra fue contaminada con sangre.',
    ...
    '/nLos entregó en poder de las naciones, /nY se enseñorearon de ellos los que les aborrecían.',
    '/nSus enemigos los oprimieron, /nY fueron quebrantados debajo de su mano.',
    '/nMuchas veces los libró; /nMas ellos se rebelaron contra su consejo, /nY fueron humillados por su maldad.',
    '/nCon todo, él miraba cuando estaban en angustia, /nY oía su clamor;',
    '/nY se acordaba de su pacto con ellos, /nY se arrepentía conforme a la muchedumbre de sus misericordias.',
    '/nHizo asimismo que tuviesen de ellos misericordia todos los que los tenían cautivos.',
    ...
    '/nBendito Jehová Dios de Israel, /nDesde la eternidad y hasta la eternidad; /nY diga todo el pueblo, /nAmén. Aleluya.'
  ],
  [
    '/nAlabad a Jehová, porque él es bueno; /nPorque para siempre es su misericordia.',
    '/nDíganlo los redimidos de Jehová, /nLos que ha redimido del poder del enemigo,',
    '/nY los ha congregado de las tierras, /nDel oriente y del occidente, /nDel norte y del sur.',
    '/nAnduvieron perdidos por el desierto, por la soledad sin camino, /nSin hallar ciudad en donde vivir.',
    '/nHambrientos y sedientos, /nSu alma desfallecía en ellos.',
    '/nEntonces clamaron a Jehová en su angustia, /nY los libró de sus aflicciones.',
    '/nLos dirigió por camino derecho, /nPara que viniesen a ciudad habitable.',
    '/nAlaben la misericordia de Jehová, /nY sus maravillas para con los hijos de los hombres.',
    '/nPorque sacia al alma menesterosa, /nY llena de bien al alma hambrienta.',
    '/nAlgunos moraban en tinieblas y sombra de muerte, /nAprisionados en aflicción y en hierros,',
    '/nPor cuanto fueron rebeldes a las palabras de Jehová, /nY aborrecieron el consejo del Altísimo.',
    '/nPor eso quebrantó con el trabajo sus corazones; /nCayeron, y no hubo quien los ayudase.',
    '/nLuego que clamaron a Jehová en su angustia, /nLos libró de sus aflicciones;',
    '/nLos sacó de las tinieblas y de la sombra de muerte, /nY rompió sus prisiones.',
    '/nAlaben la misericordia de Jehová, /nY sus maravillas para con los hijos de los hombres.',
    '/nPorque quebrantó las puertas de bronce, /nY desmenuzó los cerrojos de hierro.',
    '/nFueron afligidos los insensatos, a causa del camino de su rebelión /nY a causa de sus maldades;',
    ...
    '/nEnvió su palabra, y los sanó, /nY los libró de su ruina.',
    '/nAlaben la misericordia de Jehová, /nY sus maravillas para con los hijos de los hombres;',
    '/nOfrezcan sacrificios de alabanza, /nY publiquen sus obras con júbilo.',
    '/nLos que descienden al mar en naves, /nY hacen negocio en las muchas aguas,',
    '/nEllos han visto las obras de Jehová, /nY sus maravillas en las profundidades.',
    '/nPorque habló, e hizo levantar un viento tempestuoso, /nQue encrespa sus ondas.',
    '/nSuben a los cielos, descienden a los abismos; /nSus almas se derriten con el mal.',
    '/nTiemblan y titubean como ebrios, /nY toda su ciencia es inútil.',
    '/nEntonces claman a Jehová en su angustia, /nY los libra de sus aflicciones.',
    '/nCambia la tempestad en sosiego, /nY se apaciguan sus ondas.',
    ...
    '/nEl convierte los ríos en desierto, /nY los manantiales de las aguas en sequedales;',
    '/nLa tierra fructífera en estéril, /nPor la maldad de los que la habitan.',
    '/nVuelve el desierto en estanques de aguas, /nY la tierra seca en manantiales.',
    '/nAllí establece a los hambrientos, /nY fundan ciudad en donde vivir.',
    '/nSiembran campos, y plantan viñas, /nY rinden abundante fruto.',
    '/nLos bendice, y se multiplican en gran manera; /nY no disminuye su ganado.',
    '/nLuego son menoscabados y abatidos /nA causa de tiranía, de males y congojas.',
    '/nEl esparce menosprecio sobre los príncipes, /nY les hace andar perdidos, vagabundos y sin camino.',
    '/nLevanta de la miseria al pobre, /nY hace multiplicar las familias como rebaños de ovejas.',
    '/nVéanlo los rectos, y alégrense, /nY todos los malos cierren su boca.',
    '/n¿Quién es sabio y guardará estas cosas, /nY entenderá las misericordias de Jehová?'
  ],
  [
    '/nMi corazón está dispuesto, oh Dios; /nCantaré y entonaré salmos; esta es mi gloria.',
    ...
    '/nPorque más grande que los cielos es tu misericordia, /nY hasta los cielos tu verdad.',
    '/nExaltado seas sobre los cielos, oh Dios, /nY sobre toda la tierra sea enaltecida tu gloria.',
    '/nPara que sean librados tus amados, /nSalva con tu diestra y respóndeme.',
    '/nDios ha dicho en su santuario: Yo me alegraré; /nRepartiré a Siquem, y mediré el valle de Sucot.',
    '/nMío es Galaad, mío es Manasés, /nY Efraín es la fortaleza de mi cabeza; /nJudá es mi legislador.',
    '/nMoab, la vasija para lavarme; /nSobre Edom echaré mi calzado; /nMe regocijaré sobre Filistea.',
    '/n¿Quién me guiará a la ciudad fortificada? /n¿Quién me guiará hasta Edom?',
    '/n¿No serás tú, oh Dios, que nos habías desechado, /nY no salías, oh Dios, con nuestros ejércitos?',
  ...
  [
    ...
    '/nMe devuelven mal por bien, /nY odio por amor.',
    '/nPon sobre él al impío, /nY Satanás esté a su diestra.',
    '/nCuando fuere juzgado, salga culpable; /nY su oración sea para pecado.',
    '/nSean sus días pocos; /nTome otro su oficio.',
    '/nSean sus hijos huérfanos, /nY su mujer viuda.',
    '/nAnden sus hijos vagabundos, y mendiguen; /nY procuren su pan lejos de sus desolados hogares.',
    ...
    '/nPor cuanto no se acordó de hacer misericordia, /nY persiguió al hombre afligido y menesteroso, /nAl quebrantado de corazón, para darle muerte.',
    ...
    '/nSéale como vestido con que se cubra, /nY en lugar de cinto con que se ciña siempre.',
    ...
    '/nPorque yo estoy afligido y necesitado, /nY mi corazón está herido dentro de mí.',
    '/nMe voy como la sombra cuando declina; /nSoy sacudido como langosta.',
    '/nMis rodillas están debilitadas a causa del ayuno, /nY mi carne desfallece por falta de gordura.',
    ...
    '/nY entiendan que esta es tu mano; /nQue tú, Jehová, has hecho esto.',
    ...
    '/nPorque él se pondrá a la diestra del pobre, /nPara librar su alma de los que le juzgan.'
  ],
  [
    '/nJehová dijo a mi Señor: /nSiéntate a mi diestra, /nHasta que ponga a tus enemigos por estrado de tus pies.',
    '/nJehová enviará desde Sion la vara de tu poder; /nDomina en medio de tus enemigos.',
    ...
    '/nJuzgará entre las naciones, /nLas llenará de cadáveres; /nQuebrantará las cabezas en muchas tierras.',
    '/nDel arroyo beberá en el camino, /nPor lo cual levantará la cabeza.'
  ],
  [
    '/nAlabaré a Jehová con todo el corazón /nEn la compañía y congregación de los rectos.',
    '/nGrandes son las obras de Jehová, /nBuscadas de todos los que las quieren.',
    '/nGloria y hermosura es su obra, /nY su justicia permanece para siempre.',
    '/nHa hecho memorables sus maravillas; /nClemente y misericordioso es Jehová.',
    '/nHa dado alimento a los que le temen; /nPara siempre se acordará de su pacto.',
    '/nEl poder de sus obras manifestó a su pueblo, /nDándole la heredad de las naciones.',
    '/nLas obras de sus manos son verdad y juicio; /nFieles son todos sus mandamientos,',
  ...
  [
    ...
    '/nSu descendencia será poderosa en la tierra; /nLa generación de los rectos será bendita.',
    '/nBienes y riquezas hay en su casa, /nY su justicia permanece para siempre.',
    '/nResplandeció en las tinieblas luz a los rectos; /nEs clemente, misericordioso y justo.',
    '/nEl hombre de bien tiene misericordia, y presta; /nGobierna sus asuntos con juicio,',
    '/nPor lo cual no resbalará jamás; /nEn memoria eterna será el justo.',
    '/nNo tendrá temor de malas noticias; /nSu corazón está firme, confiado en Jehová.',
    '/nAsegurado está su corazón; no temerá, /nHasta que vea en sus enemigos su deseo.',
  ...
  [
    '/nAlabad, siervos de Jehová, /nAlabad el nombre de Jehová.',
    '/nSea el nombre de Jehová bendito /nDesde ahora y para siempre.',
    '/nDesde el nacimiento del sol hasta donde se pone, /nSea alabado el nombre de Jehová.',
    '/nExcelso sobre todas las naciones es Jehová, /nSobre los cielos su gloria.',
    '/n¿Quién como Jehová nuestro Dios, /nQue se sienta en las alturas,',
    '/nQue se humilla a mirar /nEn el cielo y en la tierra?',
    '/nEl levanta del polvo al pobre, /nY al menesteroso alza del muladar,',
    '/nPara hacerlos sentar con los príncipes, /nCon los príncipes de su pueblo.',
    '/nEl hace habitar en familia a la estéril, /nQue se goza en ser madre de hijos. /nAleluya.'
  ],
  [
    '/nCuando salió Israel de Egipto, /nLa casa de Jacob del pueblo extranjero,',
    '/nJudá vino a ser su santuario, /nE Israel su señorío.',
    '/nEl mar lo vio, y huyó; /nEl Jordán se volvió atrás.',
    '/nLos montes saltaron como carneros, /nLos collados como corderitos.',
    '/n¿Qué tuviste, oh mar, que huiste? /n¿Y tú, oh Jordán, que te volviste atrás?',
    '/nOh montes, ¿por qué saltasteis como carneros, /nY vosotros, collados, como corderitos?',
    '/nA la presencia de Jehová tiembla la tierra, /nA la presencia del Dios de Jacob,',
    '/nEl cual cambió la peña en estanque de aguas, /nY en fuente de aguas la roca.'
  ],
  [
    '/nNo a nosotros, oh Jehová, no a nosotros, /nSino a tu nombre da gloria, /nPor tu misericordia, por tu verdad.',
    '/n¿Por qué han de decir las gentes: /n¿Dónde está ahora su Dios?',
    '/nNuestro Dios está en los cielos; /nTodo lo que quiso ha hecho.',
    '/nLos ídolos de ellos son plata y oro, /nObra de manos de hombres.',
    '/nTienen boca, mas no hablan; /nTienen ojos, mas no ven;',
    '/nOrejas tienen, mas no oyen; /nTienen narices, mas no huelen;',
    ...
    '/nOh Israel, confía en Jehová; /nEl es tu ayuda y tu escudo.',
    '/nCasa de Aarón, confiad en Jehová; /nEl es vuestra ayuda y vuestro escudo.',
    '/nLos que teméis a Jehová, confiad en Jehová; /nEl es vuestra ayuda y vuestro escudo.',
    '/nJehová se acordó de nosotros; nos bendecirá; /nBendecirá a la casa de Israel; /nBendecirá a la casa de Aarón.',
    '/nBendecirá a los que temen a Jehová, /nA pequeños y a grandes.',
    '/nAumentará Jehová bendición sobre vosotros; /nSobre vosotros y sobre vuestros hijos.',
    '/nBenditos vosotros de Jehová, /nQue hizo los cielos y la tierra.',
    '/nLos cielos son los cielos de Jehová; /nY ha dado la tierra a los hijos de los hombres.',
    '/nNo alabarán los muertos a JAH, /nNi cuantos descienden al silencio;',
    '/nPero nosotros bendeciremos a JAH /nDesde ahora y para siempre. /nAleluya.'
  ],
  [
    '/nAmo a Jehová, pues ha oído /nMi voz y mis súplicas;',
    '/nPorque ha inclinado a mí su oído; /nPor tanto, le invocaré en todos mis días.',
    ...
    '/nCreí; por tanto hablé, /nEstando afligido en gran manera.',
    '/nY dije en mi apresuramiento: /nTodo hombre es mentiroso.',
    '/n¿Qué pagaré a Jehová /nPor todos sus beneficios para conmigo?',
    '/nTomaré la copa de la salvación, /nE invocaré el nombre de Jehová.',
    '/nAhora pagaré mis votos a Jehová /nDelante de todo su pueblo.',
    '/nEstimada es a los ojos de Jehová /nLa muerte de sus santos.',
    ...
    '/nA Jehová pagaré ahora mis votos /nDelante de todo su pueblo,',
    '/nEn los atrios de la casa de Jehová, /nEn medio de ti, oh Jerusalén. /nAleluya.'
  ],
  [
    '/nAlabad a Jehová, naciones todas; /nPueblos todos, alabadle.',
    '/nPorque ha engrandecido sobre nosotros su misericordia, /nY la fidelidadde Jehová es para siempre. /nAleluya.'
  ],
  [
    '/nAlabad a Jehová, porque él es bueno; /nPorque para siempre es su misericordia.',
    '/nDiga ahora Israel, /nQue para siempre es su misericordia.',
    '/nDiga ahora la casa de Aarón, /nQue para siempre es su misericordia.',
    ...
    '/nMejor es confiar en Jehová /nQue confiar en el hombre.',
    '/nMejor es confiar en Jehová /nQue confiar en príncipes.',
    '/nTodas las naciones me rodearon; /nMas en el nombre de Jehová yo las destruiré.',
    ...
    '/nMi fortaleza y mi cántico es JAH, /nY él me ha sido por salvación.',
    '/nVoz de júbilo y de salvación hay en las tiendas de los justos; /nLa diestra de Jehová hace proezas.',
    '/nLa diestra de Jehová es sublime; /nLa diestra de Jehová hace valentías.',
    '/nNo moriré, sino que viviré, /nY contaré las obras de JAH.',
    ...
    '/nEsta es puerta de Jehová; /nPor ella entrarán los justos.',
    '/nTe alabaré porque me has oído, /nY me fuiste por salvación.',
    '/nLa piedra que desecharon los edificadores /nHa venido a ser cabeza del ángulo.',
    '/nDe parte de Jehová es esto, /nY es cosa maravillosa a nuestros ojos.',
    '/nEste es el día que hizo Jehová; /nNos gozaremos y alegraremos en él.',
    ...
    '/nMi Dios eres tú, y te alabaré; /nDios mío, te exaltaré.',
    '/nAlabad a Jehová, porque él es bueno; /nPorque para siempre es su misericordia.'
  ],
  [
    '/nBienaventurados los perfectos de camino, /nLos que andan en la ley de Jehová.',
    '/nBienaventurados los que guardan sus testimonios, /nY con todo el corazón le buscan;',
    '/nPues no hacen iniquidad /nLos que andan en sus caminos.',
    '/nTú encargaste /nQue sean muy guardados tus mandamientos.',
    '/n¡Ojalá fuesen ordenados mis caminos /nPara guardar tus estatutos!',
    '/nEntonces no sería yo avergonzado, /nCuando atendiese a todos tus mandamientos.',
    '/nTe alabaré con rectitud de corazón /nCuando aprendiere tus justos juicios.',
    '/nTus estatutos guardaré; /nNo me dejes enteramente.',
    '/n¿Con qué limpiará el joven su camino? /nCon guardar tu palabra.',
    '/nCon todo mi corazón te he buscado; /nNo me dejes desviarme de tus mandamientos.',
    '/nEn mi corazón he guardado tus dichos, /nPara no pecar contra ti.',
    '/nBendito tú, oh Jehová; /nEnséñame tus estatutos.',
    '/nCon mis labios he contado /nTodos los juicios de tu boca.',
    '/nMe he gozado en el camino de tus testimonios /nMás que de toda riqueza.',
    '/nEn tus mandamientos meditaré; /nConsideraré tus caminos.',
    '/nMe regocijaré en tus estatutos; /nNo me olvidaré de tus palabras.',
    '/nHaz bien a tu siervo; que viva, /nY guarde tu palabra.',
    '/nAbre mis ojos, y miraré /nLas maravillas de tu ley.',
    '/nForastero soy yo en la tierra; /nNo encubras de mí tus mandamientos.',
    '/nQuebrantada está mi alma de desear /nTus juicios en todo tiempo.',
    '/nReprendiste a los soberbios, los malditos, /nQue se desvían de tus mandamientos.',
    '/nAparta de mí el oprobio y el menosprecio, /nPorque tus testimonios he guardado.',
    '/nPríncipes también se sentaron y hablaron contra mí; /nMas tu siervo meditaba en tus estatutos,',
    '/nPues tus testimonios son mis delicias /nY mis consejeros.',
    '/nAbatida hasta el polvo está mi alma; /nVivifícame según tu palabra.',
    '/nTe he manifestado mis caminos, y me has respondido; /nEnséñame tus estatutos.',
    '/nHazme entender el camino de tus mandamientos, /nPara que medite en tus maravillas.',
    '/nSe deshace mi alma de ansiedad; /nSusténtame según tu palabra.',
    '/nAparta de mí el camino de la mentira, /nY en tu misericordia concédeme tu ley.',
    '/nEscogí el camino de la verdad; /nHe puesto tus juicios delante de mí.',
    '/nMe he apegado a tus testimonios; /nOh Jehová, no me avergüences.',
    '/nPor el camino de tus mandamientos correré, /nCuando ensanches mi corazón.',
    '/nEnséñame, oh Jehová, el camino de tus estatutos, /nY lo guardaré hasta el fin.',
    '/nDame entendimiento, y guardaré tu ley, /nY la cumpliré de todo corazón.',
    '/nGuíame por la senda de tus mandamientos, /nPorque en ella tengo mi voluntad.',
    '/nInclina mi corazón a tus testimonios, /nY no a la avaricia.',
    '/nAparta mis ojos, que no vean la vanidad; /nAvívame en tu camino.',
    '/nConfirma tu palabra a tu siervo, /nQue te teme.',
    '/nQuita de mí el oprobio que he temido, /nPorque buenos son tus juicios.',
    '/nHe aquí yo he anhelado tus mandamientos; /nVivifícame en tu justicia.',
    ...
    '/nNo quites de mi boca en ningún tiempo la palabra de verdad, /nPorque en tus juicios espero.',
    '/nGuardaré tu ley siempre, /nPara siempre y eternamente.',
    '/nY andaré en libertad, /nPorque busqué tus mandamientos.',
    '/nHablaré de tus testimonios delante de los reyes, /nY no me avergonzaré;',
    '/nY me regocijaré en tus mandamientos, /nLos cuales he amado.',
    '/nAlzaré asimismo mis manos a tus mandamientos que amé, /nY meditaré en tus estatutos.',
    ...
    '/nMe acordé, oh Jehová, de tus juicios antiguos, /nY me consolé.',
    '/nHorror se apoderó de mí a causa de los inicuos /nQue dejan tu ley.',
    '/nCánticos fueron para mí tus estatutos /nEn la casa en donde fui extranjero.',
    '/nMe acordé en la noche de tu nombre, oh Jehová, /nY guardé tu ley.',
    '/nEstas bendiciones tuve /nPorque guardé tus mandamientos.',
    ...
    '/nConsideré mis caminos, /nY volví mis pies a tus testimonios.',
    ...
    '/nCompañero soy yo de todos los que te temen /nY guardan tus mandamientos.',
    '/nDe tu misericordia, oh Jehová, está llena la tierra; /nEnséñame tus estatutos.',
    '/nBien has hecho con tu siervo, /nOh Jehová, conforme a tu palabra.',
    '/nEnséñame buen sentido y sabiduría, /nPorque tus mandamientos he creído.',
    '/nAntes que fuera yo humillado, descarriado andaba; /nMas ahora guardo tu palabra.',
    '/nBueno eres tú, y bienhechor; /nEnséñame tus estatutos.',
    '/nContra mí forjaron mentira los soberbios, /nMas yo guardaré de todo corazón tus mandamientos.',
    '/nSe engrosó el corazón de ellos como sebo, /nMas yo en tu ley me he regocijado.',
    '/nBueno me es haber sido humillado, /nPara que aprenda tus estatutos.',
    '/nMejor me es la ley de tu boca /nQue millares de oro y plata.',
    '/nTus manos me hicieron y me formaron; /nHazme entender, y aprenderé tus mandamientos.',
    ...
    '/nVuélvanse a mí los que te temen /nY conocen tus testimonios.',
    ...
    '/nDesfallecieron mis ojos por tu palabra, /nDiciendo: ¿Cuándo me consolarás?',
    '/nPorque estoy como el odre al humo; /nPero no he olvidado tus estatutos.',
    '/n¿Cuántos son los días de tu siervo? /n¿Cuándo harás juicio contra los que me persiguen?',
    '/nLos soberbios me han cavado hoyos; /nMas no proceden según tu ley.',
    '/nTodos tus mandamientos son verdad; /nSin causa me persiguen; ayúdame.',
    '/nCasi me han echado por tierra, /nPero no he dejado tus mandamientos.',
    ...
    '/nDe generación en generación es tu fidelidad; /nTú afirmaste la tierra, y subsiste.',
    '/nPor tu ordenación subsisten todas las cosas hasta hoy, /nPues todas ellas te sirven.',
    '/nSi tu ley no hubiese sido mi delicia, /nYa en mi aflicción hubiera perecido.',
    '/nNunca jamás me olvidaré de tus mandamientos, /nPorque con ellos me has vivificado.',
    '/nTuyo soy yo, sálvame, /nPorque he buscado tus mandamientos.',
    '/nLos impíos me han aguardado para destruirme; /nMas yo consideraré tus testimonios.',
    '/nA toda perfección he visto fin; /nAmplio sobremanera es tu mandamiento.',
    '/n¡Oh, cuánto amo yo tu ley! /nTodo el día es ella mi meditación.',
    '/nMe has hecho más sabio que mis enemigos con tus mandamientos, /nPorque siempre están conmigo.',
    '/nMás que todos mis enseñadores he entendido, /nPorque tus testimonios son mi meditación.',
    '/nMás que los viejos he entendido, /nPorque he guardado tus mandamientos;',
    '/nDe todo mal camino contuve mis pies, /nPara guardar tu palabra.',
    '/nNo me aparté de tus juicios, /nPorque tú me enseñaste.',
    '/n¡Cuán dulces son a mi paladar tus palabras! /nMás que la miel a mi boca.',
    '/nDe tus mandamientos he adquirido inteligencia; /nPor tanto, he aborrecido todo camino de mentira.',
    '/nLámpara es a mis pies tu palabra, /nY lumbrera a mi camino.',
    '/nJuré y ratifiqué /nQue guardaré tus justos juicios.',
    '/nAfligido estoy en gran manera; /nVivifícame, oh Jehová, conforme a tu palabra.',
    '/nTe ruego, oh Jehová, que te sean agradables los sacrificios voluntarios de mi boca, /nY me enseñes tus juicios.',
    '/nMi vida está de continuo en peligro, /nMas no me he olvidado de tu ley.',
    '/nMe pusieron lazo los impíos, /nPero yo no me desvié de tus mandamientos.',
    '/nPor heredad he tomado tus testimonios para siempre, /nPorque son el gozo de mi corazón.',
    '/nMi corazón incliné a cumplir tus estatutos /nDe continuo, hasta el fin.',
    '/nAborrezco a los hombres hipócritas; /nMas amo tu ley.',
    '/nMi escondedero y mi escudo eres tú; /nEn tu palabra he esperado.',
    ...
    '/nHollaste a todos los que se desvían de tus estatutos, /nPorque su astucia es falsedad.',
    '/nComo escorias hiciste consumir a todos los impíos de la tierra; /nPor tanto, yo he amado tus testimonios.',
    '/nMi carne se ha estremecido por temor de ti, /nY de tus juicios tengo miedo.',
    '/nJuicio y justicia he hecho; /nNo me abandones a mis opresores.',
    '/nAfianza a tu siervo para bien; /nNo permitas que los soberbios me opriman.',
    '/nMis ojos desfallecieron por tu salvación, /nY por la palabra de tu justicia.',
    '/nHaz con tu siervo según tu misericordia, /nY enséñame tus estatutos.',
    '/nTu siervo soy yo, dame entendimiento /nPara conocer tus testimonios.',
    '/nTiempo es de actuar, oh Jehová, /nPorque han invalidado tu ley.',
    '/nPor eso he amado tus mandamientos /nMás que el oro, y más que oro muy puro.',
    '/nPor eso estimé rectos todos tus mandamientos sobre todas las cosas, /nY aborrecí todo camino de mentira.',
    '/nMaravillosos son tus testimonios; /nPor tanto, los ha guardado mi alma.',
    '/nLa exposición de tus palabras alumbra; /nHace entender a los simples.',
    '/nMi boca abrí y suspiré, /nPorque deseaba tus mandamientos.',
    ...
    '/nLíbrame de la violencia de los hombres, /nY guardaré tus mandamientos.',
    '/nHaz que tu rostro resplandezca sobre tu siervo, /nY enséñame tus estatutos.',
    '/nRíos de agua descendieron de mis ojos, /nPorque no guardaban tu ley.',
    '/nJusto eres tú, oh Jehová, /nY rectos tus juicios.',
    '/nTus testimonios, que has recomendado, /nSon rectos y muy fieles.',
    '/nMi celo me ha consumido, /nPorque mis enemigos se olvidaron de tus palabras.',
    '/nSumamente pura es tu palabra, /nY la ama tu siervo.',
    '/nPequeño soy yo, y desechado, /nMas no me he olvidado de tus mandamientos.',
    '/nTu justicia es justicia eterna, /nY tu ley la verdad.',
    '/nAflicción y angustia se han apoderado de mí, /nMas tus mandamientos fueron mi delicia.',
    '/nJusticia eterna son tus testimonios; /nDame entendimiento, y viviré.',
    '/nClamé con todo mi corazón; respóndeme, Jehová, /nY guardaré tus estatutos.',
    '/nA ti clamé; sálvame, /nY guardaré tus testimonios.',
    ...
    '/nSe acercaron a la maldad los que me persiguen; /nSe alejaron de tu ley.',
    '/nCercano estás tú, oh Jehová, /nY todos tus mandamientos son verdad.',
    '/nHace ya mucho que he entendido tus testimonios, /nQue para siempre los has establecido.',
    '/nMira mi aflicción, y líbrame, /nPorque de tu ley no me he olvidado.',
    '/nDefiende mi causa, y redímeme; /nVivifícame con tu palabra.',
    '/nLejos está de los impíos la salvación, /nPorque no buscan tus estatutos.',
    '/nMuchas son tus misericordias, oh Jehová; /nVivifícame conforme a tus juicios.',
    '/nMuchos son mis perseguidores y mis enemigos, /nMas de tus testimonios no me he apartado.',
    '/nVeía a los prevaricadores, y me disgustaba, /nPorque no guardaban tus palabras.',
    '/nMira, oh Jehová, que amo tus mandamientos; /nVivifícame conforme a tu misericordia.',
    '/nLa suma de tu palabra es verdad, /nY eterno es todo juicio de tu justicia.',
    '/nPríncipes me han perseguido sin causa, /nPero mi corazón tuvo temor de tus palabras.',
    '/nMe regocijo en tu palabra /nComo el que halla muchos despojos.',
    '/nLa mentira aborrezco y abomino; /nTu ley amo.',
    '/nSiete veces al día te alabo /nA causa de tus justos juicios.',
    '/nMucha paz tienen los que aman tu ley, /nY no hay para ellos tropiezo.',
    '/nTu salvación he esperado, oh Jehová, /nY tus mandamientos he puesto por obra.',
    '/nMi alma ha guardado tus testimonios, /nY los he amado en gran manera.',
    '/nHe guardado tus mandamientos y tus testimonios, /nPorque todos mis caminos están delante de ti.',
    '/nLlegue mi clamor delante de ti, oh Jehová; /nDame entendimiento conforme a tu palabra.',
    '/nLLegue mi oración delante de ti; /nLíbrame conforme a tu dicho.',
    '/nMis labios rebosarán alabanza /nCuando me enseñes tus estatutos.',
    '/nHablará mi lengua tus dichos, /nPorque todos tus mandamientos son justicia.',
    '/nEsté tu mano pronta para socorrerme, /nPorque tus mandamientos he escogido.',
    '/nHe deseado tu salvación, oh Jehová, /nY tu ley es mi delicia.',
    '/nViva mi alma y te alabe, /nY tus juicios me ayuden.',
    '/nYo anduve errante como oveja extraviada; busca a tu siervo, /nPorque no me he olvidado de tus mandamientos.'
  ],
  [
    '/nA Jehová clamé estando en angustia, /nY él me respondió.',
    '/nLibra mi alma, oh Jehová, del labio mentiroso, /nY de la lengua fraudulenta.',
    '/n¿Qué te dará, o qué te aprovechará, /nOh lengua engañosa?',
    ...
    '/nYo soy pacífico; /nMas ellos, así que hablo, me hacen guerra.'
  ],
  [
    '/nAlzaré mis ojos a los montes; /n¿De dónde vendrá mi socorro?',
    '/nMi socorro viene de Jehová, /nQue hizo los cielos y la tierra.',
    '/nNo dará tu pie al resbaladero, /nNi se dormirá el que te guarda.',
    '/nHe aquí, no se adormecerá ni dormirá /nEl que guarda a Israel.',
    '/nJehová es tu guardador; /nJehová es tu sombra a tu mano derecha.',
    '/nEl sol no te fatigará de día, /nNi la luna de noche.',
    '/nJehová te guardará de todo mal; /nEl guardará tu alma.',
    '/nJehová guardará tu salida y tu entrada /nDesde ahora y para siempre.'
  ],
  [
    '/nYo me alegré con los que me decían: /nA la casa de Jehová iremos.',
    '/nNuestros pies estuvieron /nDentro de tus puertas, oh Jerusalén.',
    '/nJerusalén, que se ha edificado /nComo una ciudad que está bien unida entre sí.',
    ...
    '/nSea la paz dentro de tus muros, /nY el descanso dentro de tus palacios.',
    '/nPor amor de mis hermanos y mis compañeros /nDiré yo: La paz sea contigo.',
    '/nPor amor a la casa de Jehová nuestro Dios /nBuscaré tu bien.'
  ],
  [
  ...
  [
    ...
    '/nA no haber estado Jehová por nosotros, /nCuando se levantaron contra nosotros los hombres,',
    '/nVivos nos habrían tragado entonces, /nCuando se encendió su furor contra nosotros.',
    ...
    '/nNuestra alma escapó cual ave del lazo de los cazadores; /nSe rompió el lazo, y escapamos nosotros.',
    '/nNuestro socorro está en el nombre de Jehová, /nQue hizo el cielo y la tierra.'
  ],
  [
    '/nLos que confían en Jehová son como el monte de Sion, /nQue no se mueve, sino que permanece para siempre.',
    ...
    '/nHaz bien, oh Jehová, a los buenos, /nY a los que son rectos en su corazón.',
  ...
  [
    ...
    '/nGrandes cosas ha hecho Jehová con nosotros; /nEstaremos alegres.',
  ...
  [
    '/nSi Jehová no edificare la casa, /nEn vano trabajan los que la edifican; /nSi Jehová no guardare la ciudad, /nEn vano vela la guardia.',
    ...
    '/nHe aquí, herencia de Jehová son los hijos; /nCosa de estima el fruto del vientre.',
  ...
  [
    '/nBienaventurado todo aquel que teme a Jehová, /nQue anda en sus caminos.',
    '/nCuando comieres el trabajo de tus manos, /nBienaventurado serás, y te irá bien.',
    '/nTu mujer será como vid que lleva fruto a los lados de tu casa; /nTus hijos como plantas de olivo alrededor de tu mesa.',
    '/nHe aquí que así será bendecido el hombre /nQue teme a Jehová.',
    '/nBendígate Jehová desde Sion, /nY veas el bien de Jerusalén todos los días de tu vida,',
    '/nY veas a los hijos de tus hijos. /nPaz sea sobre Israel.'
  ],
  [
    '/nMucho me han angustiado desde mi juventud, /nPuede decir ahora Israel;',
    '/nMucho me han angustiado desde mi juventud; /nMas no prevalecieron contra mí.',
    '/nSobre mis espaldas araron los aradores; /nHicieron largos surcos.',
    '/nJehová es justo; /nCortó las coyundas de los impíos.',
    '/nSerán avergonzados y vueltos atrás /nTodos los que aborrecen a Sion.',
    '/nSerán como la hierba de los tejados, /nQue se seca antes que crezca;',
  ...
  [
    '/nDe lo profundo, oh Jehová, a ti clamo.',
    ...
    '/nPero en ti hay perdón, /nPara que seas reverenciado.',
    ...
    '/nY él redimirá a Israel /nDe todos sus pecados.'
  ],
  [
    '/nJehová, no se ha envanecido mi corazón, ni mis ojos se enaltecieron; /nNi anduve en grandezas, /nNi en cosas demasiado sublimes para mí.',
    ...
    '/nEspera, oh Israel, en Jehová, /nDesde ahora y para siempre.'
  ],
  [
    '/nAcuérdate, oh Jehová, de David, /nY de toda su aflicción;',
    '/nDe cómo juró a Jehová, /nY prometió al Fuerte de Jacob:',
    '/nNo entraré en la morada de mi casa, /nNi subiré sobre el lecho de mi estrado;',
    '/nNo daré sueño a mis ojos, /nNi a mis párpados adormecimiento,',
    '/nHasta que halle lugar para Jehová, /nMorada para el Fuerte de Jacob.',
    '/nHe aquí en Efrata lo oímos; /nLo hallamos en los campos del bosque.',
    '/nEntraremos en su tabernáculo; /nNos postraremos ante el estrado de sus pies.',
    '/nLevántate, oh Jehová, al lugar de tu reposo, /nTú y el arca de tu poder.',
    '/nTus sacerdotes se vistan de justicia, /nY se regocijen tus santos.',
    '/nPor amor de David tu siervo /nNo vuelvas de tu ungido el rostro.',
    '/nEn verdad juró Jehová a David, /nY no se retractará de ello: /nDe tu descendencia pondré sobre tu trono.',
    '/nSi tus hijos guardaren mi pacto, /nY mi testimonio que yo les enseñaré, /nSus hijos también se sentarán sobre tu trono para siempre.',
    '/nPorque Jehová ha elegido a Sion; /nLa quiso por habitación para sí.',
    '/nEste es para siempre el lugar de mi reposo; /nAquí habitaré, porque la he querido.',
    '/nBendeciré abundantemente su provisión; /nA sus pobres saciaré de pan.',
    '/nAsimismo vestiré de salvación a sus sacerdotes, /nY sus santos darán voces de júbilo.',
    '/nAllí haré retoñar el poder de David; /nHe dispuesto lámpara a mi ungido.',
    '/nA sus enemigos vestiré de confusión, /nMas sobre él florecerá su corona.'
  ],
  [
    '/n¡Mirad cuán bueno y cuán delicioso es /nHabitar los hermanos juntos en armonía!',
    '/nEs como el buen óleo sobre la cabeza, /nEl cual desciende sobre la barba, /nLa barba de Aarón, /nY baja hasta el borde de sus vestiduras;',
  ...
  [
    ...
    '/nAlzad vuestras manos al santuario, /nY bendecid a Jehová.',
    '/nDesde Sion te bendiga Jehová, /nEl cual ha hecho los cielos y la tierra.'
  ],
  [
    '/nAlabad el nombre de Jehová; /nAlabadle, siervos de Jehová;',
    '/nLos que estáis en la casa de Jehová, /nEn los atrios de la casa de nuestro Dios.',
    '/nAlabad a JAH, porque él es bueno; /nCantad salmos a su nombre, porque él es benigno.',
    '/nPorque JAH ha escogido a Jacob para sí, /nA Israel por posesión suya.',
    '/nPorque yo sé que Jehová es grande, /nY el Señor nuestro, mayor que todos los dioses.',
    ...
    '/nEnvió señales y prodigios en medio de ti, oh Egipto, /nContra Faraón, y contra todos sus siervos.',
    '/nDestruyó a muchas naciones, /nY mató a reyes poderosos;',
    '/nA Sehón rey amorreo, /nA Og rey de Basán, /nY a todos los reyes de Canaán.',
    '/nY dio la tierra de ellos en heredad, /nEn heredad a Israel su pueblo.',
    '/nOh Jehová, eterno es tu nombre; /nTu memoria, oh Jehová, de generación en generación.',
    '/nPorque Jehová juzgará a su pueblo, /nY se compadecerá de sus siervos.',
    '/nLos ídolos de las naciones son plata y oro, /nObra de manos de hombres.',
    '/nTienen boca, y no hablan; /nTienen ojos, y no ven;',
    '/nTienen orejas, y no oyen; /nTampoco hay aliento en sus bocas.',
    '/nSemejantes a ellos son los que los hacen, /nY todos los que en ellos confían.',
    '/nCasa de Israel, bendecid a Jehová; /nCasa de Aarón, bendecid a Jehová;',
    '/nCasa de Leví, bendecid a Jehová; /nLos que teméis a Jehová, bendecid a Jehová.',
    '/nDesde Sion sea bendecido Jehová, /nQuien mora en Jerusalén. /nAleluya.'
  ],
  [
    '/nAlabad a Jehová, porque él es bueno, /nPorque para siempre es su misericordia.',
    '/nAlabad al Dios de los dioses, /nPorque para siempre es su misericordia.',
    '/nAlabad al Señor de los señores, /nPorque para siempre es su misericordia.',
    '/nAl único que hace grandes maravillas, /nPorque para siempre es su misericordia.',
    '/nAl que hizo los cielos con entendimiento, /nPorque para siempre es su misericordia.',
    '/nAl que extendió la tierra sobre las aguas, /nPorque para siempre es su misericordia.',
    '/nAl que hizo las grandes lumbreras, /nPorque para siempre es su misericordia.',
    '/nEl sol para que señorease en el día, /nPorque para siempre es su misericordia.',
    '/nLa luna y las estrellas para que señoreasen en la noche, /nPorque para siempre es su misericordia.',
    '/nAl que hirió a Egipto en sus primogénitos, /nPorque para siempre es su misericordia.',
    '/nAl que sacó a Israel de en medio de ellos, /nPorque para siempre es su misericordia.',
    '/nCon mano fuerte, y brazo extendido, /nPorque para siempre es su misericordia.',
    '/nAl que dividió el Mar Rojo en partes, /nPorque para siempre es su misericordia;',
    '/nE hizo pasar a Israel por en medio de él, /nPorque para siempre es su misericordia;',
    '/nY arrojó a Faraón y a su ejército en el Mar Rojo, /nPorque para siempre es su misericordia.',
    '/nAl que pastoreó a su pueblo por el desierto, /nPorque para siempre es su misericordia.',
    '/nAl que hirió a grandes reyes, /nPorque para siempre es su misericordia;',
    '/nY mató a reyes poderosos, /nPorque para siempre es su misericordia;',
    '/nA Sehón rey amorreo, /nPorque para siempre es su misericordia;',
    '/nY a Og rey de Basán, /nPorque para siempre es su misericordia;',
    '/nY dio la tierra de ellos en heredad, /nPorque para siempre es su misericordia;',
    '/nEn heredad a Israel su siervo, /nPorque para siempre es su misericordia.',
    '/nEl es el que en nuestro abatimiento se acordó de nosotros, /nPorque para siempre es su misericordia;',
    '/nY nos rescató de nuestros enemigos, /nPorque para siempre es su misericordia.',
    '/nEl que da alimento a todo ser viviente, /nPorque para siempre es su misericordia.',
    '/nAlabad al Dios de los cielos, /nPorque para siempre es su misericordia.'
  ],
  [
    '/nJunto a los ríos de Babilonia, /nAllí nos sentábamos, y aun llorábamos, /nAcordándonos de Sion.',
    '/nSobre los sauces en medio de ella /nColgamos nuestras arpas.',
    ...
    '/n¿Cómo cantaremos cántico de Jehová /nEn tierra de extraños?',
    ...
    '/nDichoso el que tomare y estrellare tus niños /nContra la peña.'
  ],
  [
    '/nTe alabaré con todo mi corazón; /nDelante de los dioses te cantaré salmos.',
    '/nMe postraré hacia tu santo templo, /nY alabaré tu nombre por tu misericordia y tu fidelidad; /nPorque has engrandecido tu nombre, y tu palabra sobre todas las cosas.',
  ...
  [
    ...
    '/nTú has conocido mi sentarme y mi levantarme; /nHas entendido desde lejos mis pensamientos.',
    '/nHas escudriñado mi andar y mi reposo, /nY todos mis caminos te son conocidos.',
    '/nPues aún no está la palabra en mi lengua, /nY he aquí, oh Jehová, tú la sabes toda.',
    '/nDetrás y delante me rodeaste, /nY sobre mí pusiste tu mano.',
    '/nTal conocimiento es demasiado maravilloso para mí; /nAlto es, no lo puedo comprender.',
    ...
    '/nSi tomare las alas del alba /nY habitare en el extremo del mar,',
    ...
    '/nAun las tinieblas no encubren de ti, /nY la noche resplandece como el día; /nLo mismo te son las tinieblas que la luz.',
    '/nPorque tú formaste mis entrañas; /nTú me hiciste en el vientre de mi madre.',
    ...
    '/nMi embrión vieron tus ojos, /nY en tu libro estaban escritas todas aquellas cosas /nQue fueron luego formadas, /nSin faltar una de ellas.',
    ...
    '/nLos aborrezco por completo; /nLos tengo por enemigos.',
    '/nExamíname, oh Dios, y conoce mi corazón; /nPruébame y conoce mis pensamientos;',
  ...
  [
    ...
    '/nAguzaron su lengua como la serpiente; /nVeneno de áspid hay debajo de sus labios. Selah',
    '/nGuárdame, oh Jehová, de manos del impío; /nLíbrame de hombres injuriosos, /nQue han pensado trastornar mis pasos.',
    '/nMe han escondido lazo y cuerdas los soberbios; /nHan tendido red junto a la senda; /nMe han puesto lazos. Selah',
    ...
    '/nCiertamente los justos alabarán tu nombre; /nLos rectos morarán en tu presencia.'
  ],
  [
    '/nJehová, a ti he clamado; apresúrate a mí; /nEscucha mi voz cuando te invocare.',
    '/nSuba mi oración delante de ti como el incienso, /nEl don de mis manos como la ofrenda de la tarde.',
    ...
    '/nCaigan los impíos a una en sus redes, /nMientras yo pasaré adelante.'
  ],
  [
    '/nCon mi voz clamaré a Jehová; /nCon mi voz pediré a Jehová misericordia.',
    '/nDelante de él expondré mi queja; /nDelante de él manifestaré mi angustia.',
  ...
  [
    ...
    '/nRespóndeme pronto, oh Jehová, porque desmaya mi espíritu; /nNo escondas de mí tu rostro, /nNo venga yo a ser semejante a los que descienden a la sepultura.',
    ...
    '/nLíbrame de mis enemigos, oh Jehová; /nEn ti me refugio.',
    '/nEnséñame a hacer tu voluntad, porque tú eres mi Dios; /nTu buen espíritu me guíe a tierra de rectitud.',
    '/nPor tu nombre, oh Jehová, me vivificarás; /nPor tu justicia sacarás mi alma de angustia.',
    '/nY por tu misericordia disiparás a mis enemigos, /nY destruirás a todos los adversarios de mi alma, /nPorque yo soy tu siervo.'
  ],
  [
    ...
    '/nOh Jehová, ¿qué es el hombre, para que en él pienses, /nO el hijo de hombre, para que lo estimes?',
    ...
    '/nDespide relámpagos y disípalos, /nEnvía tus saetas y túrbalos.',
    '/nEnvía tu mano desde lo alto; /nRedímeme, y sácame de las muchas aguas, /nDe la mano de los hombres extraños,',
    '/nCuya boca habla vanidad, /nY cuya diestra es diestra de mentira.',
    ...
    '/nNuestros graneros llenos, provistos de toda suerte de grano; /nNuestros ganados, que se multipliquen a millares y decenas de millares en nuestros campos;',
    ...
    '/nBienaventurado el pueblo que tiene esto; /nBienaventurado el pueblo cuyo Dios es Jehová.'
  ],
  [
    ...
    '/nGrande es Jehová, y digno de suprema alabanza; /nY su grandeza es inescrutable.',
    '/nGeneración a generación celebrará tus obras, /nY anunciará tus poderosos hechos.',
    '/nEn la hermosura de la gloria de tu magnificencia, /nY en tus hechos maravillosos meditaré.',
    '/nDel poder de tus hechos estupendos hablarán los hombres, /nY yo publicaré tu grandeza.',
    ...
    '/nBueno es Jehová para con todos, /nY sus misericordias sobre todas sus obras.',
    '/nTe alaben, oh Jehová, todas tus obras, /nY tus santos te bendigan.',
    '/nLa gloria de tu reino digan, /nY hablen de tu poder,',
    '/nPara hacer saber a los hijos de los hombres sus poderosos hechos, /nY la gloria de la magnificencia de su reino.',
    '/nTu reino es reino de todos los siglos, /nY tu señorío en todas las generaciones.',
    '/nSostiene Jehová a todos los que caen, /nY levanta a todos los oprimidos.',
    ...
    '/nJusto es Jehová en todos sus caminos, /nY misericordioso en todas sus obras.',
    '/nCercano está Jehová a todos los que le invocan, /nA todos los que le invocan de veras.',
    '/nCumplirá el deseo de los que le temen; /nOirá asimismo el clamor de ellos, y los salvará.',
    '/nJehová guarda a todos los que le aman, /nMas destruirá a todos los impíos.',
    '/nLa alabanza de Jehová proclamará mi boca; /nY todos bendigan su santo nombre eternamente y para siempre.'
  ],
  [
    '/nAlaba, oh alma mía, a Jehová.',
    ...
    '/nPues sale su aliento, y vuelve a la tierra; /nEn ese mismo día perecen sus pensamientos.',
    '/nBienaventurado aquel cuyo ayudador es el Dios de Jacob, /nCuya esperanza está en Jehová su Dios,',
    ...
    '/nJehová abre los ojos a los ciegos; /nJehová levanta a los caídos; /nJehová ama a los justos.',
    '/nJehová guarda a los extranjeros; /nAl huérfano y a la viuda sostiene, /nY el camino de los impíos trastorna.',
    '/nReinará Jehová para siempre; /nTu Dios, oh Sion, de generación en generación. /nAleluya.'
  ],
  [
    '/nAlabad a JAH, /nPorque es bueno cantar salmos a nuestro Dios; /nPorque suave y hermosa es la alabanza.',
    ...
    '/nEl cuenta el número de las estrellas; /nA todas ellas llama por sus nombres.',
    '/nGrande es el Señor nuestro, y de mucho poder; /nY su entendimiento es infinito.',
    '/nJehová exalta a los humildes, /nY humilla a los impíos hasta la tierra.',
    '/nCantad a Jehová con alabanza, /nCantad con arpa a nuestro Dios.',
    '/nEl es quien cubre de nubes los cielos, /nEl que prepara la lluvia para la tierra, /nEl que hace a los montes producir hierba.',
    ...
    '/nAlaba a Jehová, Jerusalén; /nAlaba a tu Dios, oh Sion.',
    '/nPorque fortificó los cerrojos de tus puertas; /nBendijo a tus hijos dentro de ti.',
    '/nEl da en tu territorio la paz; /nTe hará saciar con lo mejor del trigo.',
    '/nEl envía su palabra a la tierra; /nVelozmente corre su palabra.',
    '/nDa la nieve como lana, /nY derrama la escarcha como ceniza.',
    '/nEcha su hielo como pedazos; /nAnte su frío, ¿quién resistirá?',
    '/nEnviará su palabra, y los derretirá; /nSoplará su viento, y fluirán las aguas.',
    '/nHa manifestado sus palabras a Jacob, /nSus estatutos y sus juicios a Israel.',
    '/nNo ha hecho así con ninguna otra de las naciones; /nY en cuanto a sus juicios, no los conocieron. /nAleluya.'
  ],
  [
    '/nAlabad a Jehová desde los cielos; /nAlabadle en las alturas.',
    '/nAlabadle, vosotros todos sus ángeles; /nAlabadle, vosotros todos sus ejércitos.',
    ...
    '/nLos hizo ser eternamente y para siempre; /nLes puso ley que no será quebrantada.',
    ...
    '/nLos montes y todos los collados, /nEl árbol de fruto y todos los cedros;',
    '/nLa bestia y todo animal, /nReptiles y volátiles;',
    '/nLos reyes de la tierra y todos los pueblos, /nLos príncipes y todos los jueces de la tierra;',
    '/nLos jóvenes y también las doncellas, /nLos ancianos y los niños.',
    '/nAlaben el nombre de Jehová, /nPorque sólo su nombre es enaltecido. /nSu gloria es sobre tierra y cielos.',
  ...
  [
    ...
    '/nRegocíjense los santos por su gloria, /nY canten aun sobre sus camas.',
    '/nExalten a Dios con sus gargantas, /nY espadas de dos filos en sus manos,',
    '/nPara ejecutar venganza entre las naciones, /nY castigo entre los pueblos;',
  ...
  [
    '/nAlabad a Dios en su santuario; /nAlabadle en la magnificencia de su firmamento.',
    '/nAlabadle por sus proezas; /nAlabadle conforme a la muchedumbre de su grandeza.',
    '/nAlabadle a son de bocina; /nAlabadle con salterio y arpa.',
    '/nAlabadle con pandero y danza; /nAlabadle con cuerdas y flautas.',
    '/nAlabadle con címbalos resonantes; /nAlabadle con címbalos de júbilo.',
    '/nTodo lo que respira alabe a JAH. /nAleluya'
  ]
];
